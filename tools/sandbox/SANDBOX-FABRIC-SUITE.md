...
Follow the `done`-slug refusal's remedy verbatim and confirm it names the durable `_lyx/shed/<slug>/` run directory, and that removing it does let the slug run again.
