---
name: crucible-reviewer-max
description: A crucible reviewer-fixer round agent at max reasoning effort — reads the per-module review prompt named in its brief and drives one independent review+fix round. Only invoked by name via subagent_type (the crucible orchestrator) — not a candidate for automatic delegation.
effort: max
---
