...
Put durable notes in this file, `_raddle/`, or code comments instead: anything versioned and merged into `main`.
...
In conversation, "Merriam" is a conversational nickname for webster's long-lived orchestrating session — today named "Master" throughout `internal/websterengine` (`master-template.md`, `RoleMaster`, etc.), paired with "Webster" after Merriam-Webster.
