...
### [NIT:consistency] Constraints section contradicts the decided guard fact
...
### [NIT:consistency] Marker template's mandated justification excludes a decided raw class
**Demoted-from:** BLOCKING
