...
### [NIT:decision] Roadmap's "optional VS Code embedding" has no stated disposition
...
### [NIT:consistency] lifecyclecli's naming deviation is never added to CONSTRAINTS.md
**Demoted-from:** BLOCKING
