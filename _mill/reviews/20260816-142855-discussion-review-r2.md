...
### [NIT:consistency] New-test count stated three different ways
...
### [NIT:consistency] Q&A restates test 4 in the exact terms §Testing forbids
**Demoted-from:** BLOCKING
...
### [NIT:scope] Stale stencil count in the sandbox suite not in the doc inventory
**Demoted-from:** BLOCKING
...
### [NIT:decision] Design doc's step 4 falsehood has no disposition
**Demoted-from:** BLOCKING
