...
### [NIT:consistency] Batchifier row keeps `plan.md`, criterion 3 forbids it
...
### [NIT:scope] `Discussion-Review-Gate` occurrence set is wrong and unreachable
**Demoted-from:** BLOCKING
...
### [NIT:decision] No disposition for inserting the new producer into `shed.md:13,41`
**Demoted-from:** BLOCKING
