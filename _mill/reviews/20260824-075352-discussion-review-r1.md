...
### [NIT:consistency] "No go test applies" is false for manifest/ links
...
### [NIT:decision] Supersession claim moved to a doc never asked to make it
**Demoted-from:** BLOCKING
...
### [NIT:decision] Stencil Step 2 "Explore before asking" has no disposition
**Demoted-from:** BLOCKING
