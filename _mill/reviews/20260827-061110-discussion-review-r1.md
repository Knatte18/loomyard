...
### [NIT:scope] internal/gitrepo absent from scope but needs four new verbs
...
_Note: 1 finding(s) demoted from BLOCKING to NIT by the stage's blocking-class ceiling; current blocking_count is 6._
MILL_REVIEW_END
