...
### [NIT:consistency] `constructoranchoring_test.go`'s header comment goes stale after Card 1's move
...
### [NIT:consistency] Card 13's resume-across-machines paragraph rewrite may leave a now-false middle sentence
**Demoted-from:** BLOCKING
