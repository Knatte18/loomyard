...
### [NIT:decision] "Retains a consumer" is ambiguous for the eleven Name\* constants
...
### [NIT:decision] `coverage_guard_test.go` holds three tests, not one
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Recipe uses nine distinct engines, not eight
**Demoted-from:** BLOCKING
...
### [NIT:consistency] CONSTRAINTS.md needs more than the enforcement-pointer fix
**Demoted-from:** BLOCKING
