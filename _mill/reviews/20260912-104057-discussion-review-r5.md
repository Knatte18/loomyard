...
### [NIT:consistency] Scope says one MkdirAll, Decision says three
...
### [NIT:consistency] Unknown `Role`: silent empty vs hard error
**Demoted-from:** BLOCKING
...
### [NIT:scope] All four webster composers need a new told parameter, not one
**Demoted-from:** BLOCKING
