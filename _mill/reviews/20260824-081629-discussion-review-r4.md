...
### [NIT:consistency] review-finding-classification.md:7 is the wrong target
...
### [NIT:decision] roadmap.md:43-47 restates Fix 2 with no disposition
**Demoted-from:** BLOCKING
...
### [NIT:scope] Deletion-handoff note has no acceptance criterion
**Demoted-from:** BLOCKING
