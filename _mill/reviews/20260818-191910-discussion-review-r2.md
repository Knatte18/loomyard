...
### [NIT:consistency] hubgeom fails the invariant's own predicate
...
### [NIT:scope] docs/shared-libs/README.md has no stated disposition
**Demoted-from:** BLOCKING
...
### [NIT:scope] doc.go audit subject set is stated as an unverifiable count
**Demoted-from:** BLOCKING
