...
### [NIT:consistency] Card 15 keeps/rewrites a design doc the Documentation Lifecycle says to delete
...
### [NIT:consistency] "Permanent full share" misattributed to the status strand's Decision
**Demoted-from:** BLOCKING
