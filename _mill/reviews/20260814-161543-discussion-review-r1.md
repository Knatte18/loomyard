...
### [NIT:scope] Sandbox suite scenarios encode the `_board` junction
...
### [NIT:scope] reed CLI help text still names `<hub>/.lyx/logs/`
**Demoted-from:** BLOCKING
...
### [NIT:decision] Stale `_board` line in existing warp `.git/info/exclude`
**Demoted-from:** BLOCKING
