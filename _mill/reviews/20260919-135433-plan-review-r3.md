...
### [NIT:decision] shedverbs helpers are unexported, yet loomcli tests are retargeted onto them
...
### [NIT:consistency] Byte-for-byte help text has neither a live source nor the claimed guard
**Demoted-from:** BLOCKING
