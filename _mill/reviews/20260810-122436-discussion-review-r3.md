...
### [NIT:decision] Rollback/other sites carry no stated ownership kind
...
### [NIT:consistency] `ownedManagedWeftBranch` given two different signatures
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Constraints section restates the superseded `l`-on-the-gate model
**Demoted-from:** BLOCKING
