...
### [NIT:consistency] Testing claims a construction failure that cannot occur
...
### [NIT:decision] `profile.fasit` for Webster-Burler is never decided
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Round artifacts are under `.lyx`, not `_lyx`
**Demoted-from:** BLOCKING
...
### [NIT:scope] The `Webster` row's outbound edge is not covered
**Demoted-from:** BLOCKING
