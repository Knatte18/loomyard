...
### [NIT:scope] roadmap.md:54 still names E as final owner
...
### [NIT:scope] loom.md row 9 still pins Batchifier to webster.yaml
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Acceptance greps contradict declared out-of-scope text
**Demoted-from:** BLOCKING
...
### [NIT:decision] loom.md:82's gate-section hand-off has no disposition
**Demoted-from:** BLOCKING
...
### [NIT:scope] E's phase-enum deferral record is not carried forward
**Demoted-from:** BLOCKING
