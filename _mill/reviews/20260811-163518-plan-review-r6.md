...
### [NIT:consistency] Card 22's `res.Mutated().Entries()` cannot compile
...
### [NIT:consistency] Card 27's reserved-key assertion is unsatisfiable for `okWithRecord`
**Demoted-from:** BLOCKING
...
### [NIT:decision] `runReconcile`'s error returns have no stated disposition
**Demoted-from:** BLOCKING
