...
### [NIT:consistency] Batch-2 verify in 00-overview.md drops the integration-tagged vet pass
...
### [NIT:consistency] Card 10 fixes one Finalize/Publish mislabel in webster-spec.md but leaves an identical one two lines above
**Demoted-from:** BLOCKING
