...
### [NIT:consistency] `loomshed.Seed` is not idempotent
...
### [NIT:decision] `Deps.WebsterRun` / `Deps.WebsterDeps` have no disposition
**Demoted-from:** BLOCKING
...
### [NIT:scope] `lyx run` becomes a registered "module" for two guards
**Demoted-from:** BLOCKING
...
### [NIT:decision] `--parent` on an already-recorded worktree left undecided
**Demoted-from:** BLOCKING
