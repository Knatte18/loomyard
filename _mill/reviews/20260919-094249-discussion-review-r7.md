...
### [NIT:consistency] Superseded "--shell validated non-empty" bullet left standing
...
### [NIT:consistency] Testing names a `reapSessionTmux` the split decision does not have
**Demoted-from:** BLOCKING
