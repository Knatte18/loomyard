...
### [NIT:consistency] `internal/lock` is not dependency-free
...
### [NIT:consistency] Test tier tag is `scout`, not `integration`
**Demoted-from:** BLOCKING
...
### [NIT:scope] gitkit/hubforge fixture inventory is wrong
**Demoted-from:** BLOCKING
...
### [NIT:scope] Removal checklist claims completeness it lacks
**Demoted-from:** BLOCKING
