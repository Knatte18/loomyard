...
### [NIT:consistency] CopyWarpHub disposition contradicts its narrowing
...
### [NIT:scope] Documentation sweep enumerates Go files only
**Demoted-from:** BLOCKING
...
### [NIT:decision] `internal/lyxtest/bench_test.go` has no stated disposition
**Demoted-from:** BLOCKING
