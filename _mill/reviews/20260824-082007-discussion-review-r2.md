...
### [NIT:decision] golang-build/golang-testing have no disposition
...
### [NIT:consistency] golang-build's toolchain contradicts this repo
**Demoted-from:** BLOCKING
...
### [NIT:consistency] prose bans "any" as an empty intensifier
**Demoted-from:** BLOCKING
