...
### [NIT:consistency] Machine-enforced predicate ignores direct-vs-transitive
...
### [NIT:consistency] Scope and Q&A contradict the overview.md decision
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Review-obligation set counted as ten, enumerated as eight
**Demoted-from:** BLOCKING
...
### [NIT:decision] Config Strictness spec paragraph has no disposition
**Demoted-from:** BLOCKING
