...
```yaml
phase: approved-configcli-json-envelope
...
task_description: |
  Fix lyx config --set dropping unrecognized keys + reconcile not detecting drift
```
...
batches:
  ...
  - name: configcli-json-envelope
    ...
    commit_sha: c163c144383e80ddee81f45f66c6ab433cf0818c
```
