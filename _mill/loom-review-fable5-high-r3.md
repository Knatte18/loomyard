...
**Merge-readiness:** with this round's fixes applied (all findings fixed, see the fixer report) — Mission A: ready; Mission B: ready. Without them, F1/F2/F-A1 each independently block.
