...
| F6 | LOW | fixed | `pending-sha` | `TestCanonicalizeHandles_OneDraftTwoCanonicalsRewritesNothing` (new) | `internal/planglyph/handle.go`, `internal/planglyph/handle_test.go` |
| F7 | LOW | pending | — | — | — |
