...
### Card 27: add the engine-less ListSessions seam
...
### Card 28: replace the header verb with statusline
...
### Card 29: add the watchdog daemon's timing constants and idle rule
...
### Card 30: add the daemon's worktree discovery
...
### Card 31: add the daemon's discovery loop and lifetime
...
### Card 33: spawn the daemon from up, resume and attach
...
### Card 34: swap the CLI invariant's interactive-handoff exception
...
### Card 35: retarget the reedcli verb tests
...
### Card 36: test the daemon's pure discovery and spawn seams
...
### Card 39: correct the engine doc's two verb-naming entries
...
### Card 40: add the watchdog daemon integration test
...
Card 40's integration-tagged assertions do not run under this untagged `verify` — they run under `pipeline.done_gate`'s `go test -tags integration ./...`, which is where every other live-tmux assertion in this repo already runs.
