...
- **Requirements:** Repoint every inbound Markdown link to the deleted document.
  ...
  - `manifest/designs/shed.md` — four links: the status banner, the worked-example line for the second producer, the task-bundling paragraph, and the Related list entry.
