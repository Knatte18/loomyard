...
### Card 4: Amend the Hub Geometry Invariant in CONSTRAINTS.md
...
- **Commit:** `docs(constraints): record injected junction name-set in Hub Geometry Invariant`
