...
### Card 15: rename the persisted state field to SelvagePaneID
...
### Card 16: split Selvage below the bottom-most pane
...
### Card 17: delete the header pane's launch composer and its test suppression
...
### Card 18: retarget reconcile's exemption and authorization onto Selvage
...
### Card 19: retarget the split-target choice onto Selvage
...
### Card 20: retarget apply and generation onto Selvage
...
### Card 21: retarget the remaining lifecycle call sites and strand accounting
...
### Card 22: rewrite the engine package doc and the integration fixtures
