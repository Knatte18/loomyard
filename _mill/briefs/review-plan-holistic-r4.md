...
You are an independent plan reviewer for **reed: per-hub daemon reaps orphaned sessions**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=38)

- _mill/plan/00-overview.md
- _mill/plan/01-reedengine-reap-seam.md
- _mill/plan/02-reedcli-decision-seams.md
- _mill/plan/03-daemon-wiring.md
- _mill/plan/04-tagged-reap-tests.md
- _mill/plan/05-docs.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap/_mill/briefs/review-plan-holistic-r4.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap/_mill/briefs/review-plan-holistic-r4.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap/_mill/briefs/review-plan-holistic-r4.out.md`
