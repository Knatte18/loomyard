...
You are an independent plan reviewer for **webster: rewrite for flat card list**. You evaluate the complete plan (all batches) and produce a structured review.

Reviewer model: **opushigh**. Round **4**.
...
- /home/knatte/Code/loomyard/wts/webster-rewrite/internal/websterengine/chain.go
- /home/knatte/Code/loomyard/wts/webster-rewrite/internal/websterengine/chain_test.go
...
- /home/knatte/Code/loomyard/wts/webster-rewrite/manifest/designs/webster-rewrite.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/webster-rewrite/_mill/briefs/review-plan-holistic-r4.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/webster-rewrite/_mill/briefs/review-plan-holistic-r4.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/webster-rewrite/_mill/briefs/review-plan-holistic-r4.out.md`
