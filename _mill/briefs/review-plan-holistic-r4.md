...
You are an independent plan reviewer for **Deploy cited spec/design docs to target repos like stencils**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/deploy-specs-like-stencils`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=87)

- _mill/plan/00-overview.md
- _mill/plan/01-specs-registry.md
- _mill/plan/02-specs-geometry.md
- _mill/plan/03-seeded-subtree-commit.md
- _mill/plan/04-specs-seeding-wiring.md
- _mill/plan/05-specs-dir-marker-plumbing.md
- _mill/plan/06-citation-rewrite-and-enforcement.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/deploy-specs-like-stencils/_mill/briefs/review-plan-holistic-r4.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/deploy-specs-like-stencils/_mill/briefs/review-plan-holistic-r4.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/deploy-specs-like-stencils/_mill/briefs/review-plan-holistic-r4.out.md`
