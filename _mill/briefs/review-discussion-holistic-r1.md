...
You are an independent discussion reviewer for **Unify webster/burler CLI wiring into a shared module**.
Round **1**.
...
Read the discussion at `/home/hanf/Code/loomyard/wts/unify-webster-burler-wiring/_mill/discussion.md`. The discussion file is the authoritative scope. Read files referenced in `## Technical Context` to verify claims.
...
Write your full report to this file: /home/hanf/Code/loomyard/wts/unify-webster-burler-wiring/_mill/briefs/review-discussion-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/loomyard/wts/unify-webster-burler-wiring/_mill/briefs/review-discussion-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/loomyard/wts/unify-webster-burler-wiring/_mill/briefs/review-discussion-holistic-r1.out.md`
