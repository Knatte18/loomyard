...
You are an independent discussion reviewer for **burler: split the round prompt into an orchestrator + three instruction files**. Round **1**. Reviewer model: **opushigh**.
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/burler-prompt-split/_mill/briefs/review-discussion-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/burler-prompt-split/_mill/briefs/review-discussion-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/burler-prompt-split/_mill/briefs/review-discussion-holistic-r1.out.md`
