...
- **Holistic review file:** `C:\Code\loomyard\wts\weft-producers\_mill\reviews\20260623-120615-code-review-r3.md`
...
Load the **mill-receiving-review** skill before reading any finding in `C:\Code\loomyard\wts\weft-producers\_mill\reviews\20260623-120615-code-review-r3.md`. This is non-negotiable.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"d7a8b2ad-f580-4dd1-8247-4948a246eda8"}
```
...
**`session_id` MUST be exactly `d7a8b2ad-f580-4dd1-8247-4948a246eda8` (the UUID shown in the example above — it was injected into this brief when it was rendered). Copy it verbatim.**

or, when stuck:

```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"d7a8b2ad-f580-4dd1-8247-4948a246eda8"}
```
**Do not wrap the JSON in a code block. Output it as a bare line — no backticks, no fence. Anything other than a bare JSON line is treated as `stuck_type: logic`.**
