...
### [BLOCKING:decision] Third AddStrand caller undispositioned
...
### [BLOCKING:consistency] Superseded "Status() → Up() swap" line
...
### [BLOCKING:scope] reed API design doc missing from the doc list
