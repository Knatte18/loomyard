...
### [BLOCKING:decision] fabriccli cannot errors.As an unexported refusal type
...
### [BLOCKING:scope] CLI-layer mutations and zero-result returns are unaccounted for
...
### [BLOCKING:scope] No Kind covers a pull/fetch advance; the partial rationale is false
