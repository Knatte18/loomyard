...
You are an independent plan reviewer for **Adopt internal/state in board and muxpoc**. You evaluate the complete plan (all batches) and produce a structured review.
