...
You are an independent plan reviewer for **Build internal/shuttle: one LLM agent via a swappable engine**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\internal-shuttle\docs\modules\shuttle.md
- C:\Code\loomyard\wts\internal-shuttle\docs\modules\mux.md
