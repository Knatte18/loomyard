...
You are an independent plan reviewer for **Optimise and slim the rest of the test suite**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\git_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\sync_test.go
