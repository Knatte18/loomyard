...
You are an independent plan reviewer for **Build internal/mux: the window to the world (overlay + strands + render)**. You evaluate the complete plan (all batches) and produce a structured review.
