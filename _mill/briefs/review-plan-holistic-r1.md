...
You are an independent plan reviewer for **Sandbox test-suite launcher and task harvester**. You evaluate the complete plan (all batches) and produce a structured review.
