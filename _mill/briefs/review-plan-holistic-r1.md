...
You are an independent plan reviewer for **Seeded Shed core: run addressing, seed contract, batten**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/seeded-shed-core`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=143)

- _mill/plan/00-overview.md
- _mill/plan/01-shedrun-leaf.md
- _mill/plan/02-board-type-field.md
- _mill/plan/03-batten-rename.md
- _mill/plan/04-loom-run-directory.md
- _mill/plan/05-batten-producers.md
- _mill/plan/06-batten-wiring.md
- _mill/plan/07-shed-addressing.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/seeded-shed-core/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/seeded-shed-core/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/seeded-shed-core/_mill/briefs/review-plan-holistic-r1.out.md`
