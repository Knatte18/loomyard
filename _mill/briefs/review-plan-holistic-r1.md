...
You are an independent plan reviewer for **Move config templates home by removing the lyxtest->configreg edge**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\config-test-cleanup\internal\configtmpl\board.yaml
- C:\Code\loomyard\wts\config-test-cleanup\internal\configtmpl\configtmpl.go
- C:\Code\loomyard\wts\config-test-cleanup\internal\board\template.go
- C:\Code\loomyard\wts\config-test-cleanup\internal\configtmpl\worktree.yaml
- C:\Code\loomyard\wts\config-test-cleanup\internal\worktree\template.go
- C:\Code\loomyard\wts\config-test-cleanup\internal\configtmpl\weft.yaml
