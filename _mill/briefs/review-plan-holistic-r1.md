...
You are an independent plan reviewer for **Build perch - the review gate loop**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\internal-perch\docs\modules\perch.md
