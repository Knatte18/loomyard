...
You are an independent plan reviewer for **Fix test-suite regression: slow Tier 1 + 2 red packages + stale benchmarks**. You evaluate the complete plan (all batches) and produce a structured review.
