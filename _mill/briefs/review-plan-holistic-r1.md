...
You are an independent plan reviewer for **Rename internal/config to internal/configengine**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\config-engine-rename\internal\config\config.go
- C:\Code\loomyard\wts\config-engine-rename\internal\config\edit.go
- C:\Code\loomyard\wts\config-engine-rename\internal\config\config_test.go
- C:\Code\loomyard\wts\config-engine-rename\internal\config\edit_test.go
...
- C:\Code\loomyard\wts\config-engine-rename\docs\shared-libs\config.md
