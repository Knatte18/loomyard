...
You are an independent plan reviewer for **fabric: fold snapshot-tracking into the Warp-SHA trailer**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\01-retire-ref-mechanism.md
- C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\02-commit-empty-primitive.md
- C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\03-snapshot-reader.md
- C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\04-empty-commit-rule.md
- C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\05-design-docs.md
...
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\snapshot.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\snapshot_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\pull.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\reset.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\worktree.go
...
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\testmain_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\gitrepo_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\gitrepo\reset_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\trailer.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\corrindex.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\fabric.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\index.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\index_integration_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\weftgit.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\checkout.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\testmain_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\syncweft_integration_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\doc.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\classify.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\junctionnames.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\commit.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\revert.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\commit_integration_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\weftgit_pathspec_integration_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\internal\fabricengine\weftgit_unborn_warp_test.go
- C:\Code\loomyard\wts\fabric-snapshot-trailer\manifest\designs\raddle.md
- C:\Code\loomyard\wts\fabric-snapshot-trailer\manifest\designs\fabric-unified-view.md

## Plan files to review
- Overview: `C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\00-overview.md`
- Batches:
- `C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\01-retire-ref-mechanism.md`
- `C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\02-commit-empty-primitive.md`
- `C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\plan\03-snapshot-reader.md`
...
Write your full report to this file: C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\briefs\review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\briefs\review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\briefs\review-plan-holistic-r1.out.md`
