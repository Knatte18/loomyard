...
You are an independent plan reviewer for **Sandbox suite: emit findings JSON on the shared analysis contract**. You evaluate the complete plan (all batches) and produce a structured review.
