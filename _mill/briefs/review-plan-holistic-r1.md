...
You are an independent plan reviewer for **Optimise and slim the test suite**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\optimize-test-suite\internal\worktree\testhelpers_test.go
...
- C:\Code\loomyard\wts\optimize-test-suite\internal\paths\helpers_test.go
...
- C:\Code\loomyard\wts\optimize-test-suite\internal\worktree\helpers_test.go
