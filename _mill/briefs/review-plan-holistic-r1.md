...
You are an independent plan reviewer for **Rename internal/ghissues → selfreport**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\rename-ghissues-to-selfreport\internal\ghissuesengine\ghissues.go
- C:\Code\loomyard\wts\rename-ghissues-to-selfreport\internal\ghissuescli\cli_test.go
- C:\Code\loomyard\wts\rename-ghissues-to-selfreport\internal\ghissuescli\cli.go
