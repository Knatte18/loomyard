...
You are an independent plan reviewer for **Rename internal/paths to internal/hubgeometry**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\paths_test.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\codeguide_guard_test.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\geometry_test.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\worktreelist_test.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\paths_unit_test.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\enforcement_test.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\paths.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\docs\shared-libs\paths.md
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\worktreelist.go
- C:\Code\loomyard\wts\rename-paths-to-hubgeometry\internal\paths\weft_test.go
