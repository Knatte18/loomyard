...
You are an independent plan reviewer for **Build internal/stencil: fill markdown prompt templates**. You evaluate the complete plan (all batches) and produce a structured review.
