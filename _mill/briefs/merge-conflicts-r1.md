...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/loom-cli-rename rm <file>`.
...
### From _mill/plan/01-go-cli-rename.md
...
### From _mill/plan/02-launchers.md
...
### From _mill/plan/03-go-comment-sweep.md
...
### From _mill/plan/04-skill-rename.md
...
### From _mill/plan/05-docs-and-manifest.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/loom-cli-rename add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/loom-cli-rename rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/loom-cli-rename` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/loom-cli-rename`.
