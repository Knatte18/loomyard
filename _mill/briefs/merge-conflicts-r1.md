...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/reed-header-selvage rm <file>`.
...
### From _mill/plan/01-render-bottom-band.md
...
### From _mill/plan/02-vocabulary-and-config.md
...
### From _mill/plan/03-selvage-pane.md
...
### From _mill/plan/04-status-line-pins.md
...
### From _mill/plan/05-watchdog-daemon.md
...
### From _mill/plan/06-standalone-watcher.md
...
### From _mill/plan/07-docs-smokes-and-residue.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/reed-header-selvage add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/reed-header-selvage rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/reed-header-selvage` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/reed-header-selvage`.
