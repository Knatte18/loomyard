...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/reed-watchdog-daemon rm <file>`.
...
### From _mill/plan/01-watchdog-foundations.md
...
### From _mill/plan/02-engine-reapply-op.md
...
### From _mill/plan/03-watch-loop.md
...
### From _mill/plan/04-cli-tail-docs-and-live-proof.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/reed-watchdog-daemon add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/reed-watchdog-daemon rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/reed-watchdog-daemon` for any git commands;
do not `cd`.
