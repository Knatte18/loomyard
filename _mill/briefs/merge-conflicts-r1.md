...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/builder-retire rm <file>`.
...
5. Run `git -C /home/knatte/Code/loomyard/wts/builder-retire add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/builder-retire rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/builder-retire` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/builder-retire`.
