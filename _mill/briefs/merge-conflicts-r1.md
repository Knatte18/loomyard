...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/self-report-tier1 rm <file>`.
...
### From _mill/plan/01-leaf-surfaces.md
...
### From _mill/plan/02-anomaly-detector.md
...
### From _mill/plan/03-drive-wiring.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/self-report-tier1 add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/self-report-tier1 rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/self-report-tier1` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/self-report-tier1`.
