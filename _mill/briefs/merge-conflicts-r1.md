...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/landing-parent-fabric-resolution-chain rm <file>`.
...
### From _mill/plan/01-fabricengine-parent-resolution.md
...
### From _mill/plan/02-loomengine-scratch-dir.md
...
### From _mill/plan/03-landingshed-comment-fixes.md
...
### From _mill/plan/04-loomcli-landing-wiring.md
...
### From _mill/plan/05-docs-roadmap-and-design.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/landing-parent-fabric-resolution-chain add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/landing-parent-fabric-resolution-chain rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/landing-parent-fabric-resolution-chain` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/landing-parent-fabric-resolution-chain`.
