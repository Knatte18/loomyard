...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/fabric-merge-conflict-primitive rm <file>`.
...
### From _mill/plan/01-gitrepo-merge-primitives.md
...
### From _mill/plan/02-merge-state-errors-mapping.md
...
### From _mill/plan/03-mergein-and-lifecycle.md
...
### From _mill/plan/04-merge-target-verb.md
...
### From _mill/plan/05-sibling-guards-vocabulary.md
...
### From _mill/plan/06-cli-and-docs.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/fabric-merge-conflict-primitive add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/fabric-merge-conflict-primitive rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/fabric-merge-conflict-primitive` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/fabric-merge-conflict-primitive`.
