...
Stage the deletion with `git -C /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap rm <file>`.
...
### From _mill/plan/01-reedengine-reap-seam.md
...
### From _mill/plan/02-reedcli-decision-seams.md
...
### From _mill/plan/03-daemon-wiring.md
...
### From _mill/plan/04-tagged-reap-tests.md
...
5. Run `git -C /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/loomyard/wts/reed-per-hub-daemon-reap`.
