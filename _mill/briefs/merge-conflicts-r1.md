...
### From _mill/plan/01-planparser-core.md
...
### From _mill/plan/02-planparser-checks.md
...
### From _mill/plan/04-gitrepo-bisect-primitive.md
...
### From _mill/plan/05-webster-mechanism-helpers.md
...
### From _mill/plan/06-webster-report-digest.md
...
### From _mill/plan/07-engine-retarget.md
...
### From _mill/plan/08-integration-fork-bisect.md
...
### From _mill/plan/09-webstercli-rewire.md
...
### From _mill/plan/10-docs-constraints.md
...
4. Run `git -C /home/knatte/Code/loomyard/wts/webster-rewrite add <file>` to stage the resolved file.
5. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/loomyard/wts/webster-rewrite rm <file>` instead of editing; that stages the intentional deletion.
6. For UD conflicts — files this branch **modified** that the parent branch **deleted**: do not silently keep the modification. Instead:
   ...
   c. If the deletion commit message mentions a replacement file (e.g. "replaced by", "moved to", "consolidated into"), or the commit also adds a file in the same directory with overlapping content: stage the deletion — `git -C /home/knatte/Code/loomyard/wts/webster-rewrite rm <file>`.
...
Available: Read, Edit, Write, Bash, Grep, Glob. Use `git -C /home/knatte/Code/loomyard/wts/webster-rewrite` for any git commands; do not `cd`. Worktree cwd is `/home/knatte/Code/loomyard/wts/webster-rewrite`.
