...
You are an independent code reviewer for **fabric: collapse external API surface onto Commit — stop leaking warp/weft**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- Stale RevertWithWeft mention in a still-open design-doc passage: Location: manifest/designs/fabric-unified-view.md:84 (fixed in round 1 fix pass)
- Doc-comment cascade left untouched in files outside the plan's edit lists: Location: internal/fabricengine/spawn.go:7,75,77, internal/fabricengine/gogit.go:147 (gitrepo package), internal/fabriccli/cli_test.go:431-436, internal/websterengine/audit.go:217 (deliberately not fixed — plan scopes comment trims to touched files only; optional future-task sweep)
...
- **Cross-module exclusions.** The `_lyx` tree is **shared** by every round-loop module in a worktree, so a module's weft commit stages whatever the *other* modules happen to have left on disk. Every caller (`internal/buildercli`'s, `internal/webstercli`'s, and `internal/perchcli`'s weft commits, plus `lyx fabric commit|push|sync`'s own pathspec in `internal/fabriccli/weft_verbs.go`) now passes a **positive-only** file list — no `:(exclude)` pathspec magic anywhere — built via `fabricengine.ScopedPathspec`. Cross-module machine-local artifacts (builder's and webster's pause flags, webster's rendered fork prompts, and every module's `*.lock` files at any depth beneath it, including perch's two-deep `_lyx/perch/<block>/run.lock`) are excluded **solely at the git-exclude layer**, never per-call: `fabricengine.seedWeftArtifactExcludes` (called from `ensureWeftLockDir`, the single choke point every weft-git verb passes through) seeds `crossModuleMachineLocalExcludes` — gitignore-syntax patterns `**/_lyx/*/**/*.lock`, `**/_lyx/*/pause`, `**/_lyx/*/prompts/` (module name wildcarded, lock pattern reaching any depth beneath the module) — into the weft repo's `.git/info/exclude`. This makes **every** committer correct by construction with no exclusion logic of its own: git itself refuses to stage these paths regardless of what pathspec asked for them, and — because gitignore glob semantics differ from git pathspec magic (a bare `*` here does **not** cross `/`) — the `**/` prefix alone reaches every `RelPath` depth with no per-caller anchoring needed; the leading-wildcard pathspec anchoring failure mode this bullet used to warn against (a `:(exclude)*.lock` pruning a whole nested-`RelPath` subtree into a silent no-op commit) cannot recur once no caller passes exclusion pathspecs at all. **Known limitation:** this stops new pollution but does not untrack an artifact a pre-fix `lyx fabric sync` already committed on an existing hub — `.git/info/exclude` only affects untracked status. `git rm --cached <path>` (or a fresh `lyx fabric sync` after manually removing the tracked entries) is the manual remedy on an already-polluted hub; no automated migration tool was added.
...
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/00-overview.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/01-bolt-handle.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/02-commit-migration.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/03-remove-force-add.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/04-clean-healthy-renames.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/05-delete-dead-methods.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/06-fabric-cli-collapse.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/weftgit.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/bolt.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/boardengine/sync.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabriccli/clone.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/coalesce.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/coalesce_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/commitweftat_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/boardengine/sync_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/bolt_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/commit.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/buildercli/weft.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/buildercli/weft_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/webstercli/weft.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/webstercli/cli_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/perchcli/run.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/unwire.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/CONSTRAINTS.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/commit_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/buildercli/weft_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/webstercli/weft_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/perchcli/run_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/gitrepo/gitrepo.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/weftgit_pathspec_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/gitrepo/noforceadd_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/hostclean.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/loomengine/preflight.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/loomengine/preflight_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/drift.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/status.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/reconcile.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/junctionnames.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/doc.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/hubgeometry/hubgeometry.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/config_driven_junctions_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/junction_pattern_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/reconcile_stale_removal_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/reconcile_stale_registration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/revert.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/diff_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/syncweft_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/weftgit_unborn_warp_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/snapshot.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/snapshot_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/index.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/topology.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/fabric.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/diff.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/checkout_index_refresh_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/commit_partial_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/revert_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/boardengine/board.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/gitrepo/doc.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/gitrepo/reset.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabriccli/weft_verbs.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabriccli/fabric.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/pull_integration_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/weftgit_exclude_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/cmd/lyx/helptree_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/manifest/designs/fabric-unified-view.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/docs/overview.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/tools/sandbox/SANDBOX-FABRIC-SUITE.md
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/boardweft.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/clone.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/output/output.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/classify.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/builderengine/pause.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/websterengine/pause.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/cmd/lyx/gitrepoboundary_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/cmd/lyx/rawgitmutation_test.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/cleanup.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/junction.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/corrindex.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/fabricengine/trailer.go
- /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/internal/clihelp/exec.go

## Plan + source files to review
- Overview: `/home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/01-bolt-handle.md`
  - `/home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/02-commit-migration.md`
  - `/home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/plan/03-remove-force-add.md`
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/fabric-collapse-external-surface/_mill/briefs/review-code-holistic-r2.out.md`
