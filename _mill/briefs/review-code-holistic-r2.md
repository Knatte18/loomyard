...
You are an independent code reviewer for **Scope the Shed producer-model rewrite into buildable tasks**.
...
- F's body drops half of the "carry rejected alternatives from both decisions" instruction: **Location:** `_mill/followup/F-batcher-standalone-split.md:19-23`
- A regroups discussion's Doc-retirement inventory under "Code deletion" instead of transcribing its own section boundaries: **Location:** `_mill/followup/A-builder-retire.md:42-49`
...
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/plan/00-overview.md
...
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup/A-builder-retire.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup/B-plan-format-drop-v3-suffix.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup/F-batcher-standalone-split.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup/C-format-docs-name-producers.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup/D-raddle-finalize-fold-and-link-repair.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup/E-shed-model-contradiction-sweep.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/followup-tasks.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/discussion.md
- /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/plan/00-overview.md

## Plan + source files to review
- Overview: `/home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/plan/01-code-task-bodies.md`
  - `/home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/plan/02-docs-task-bodies.md`
  - `/home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/plan/03-wiki-publish-and-summary.md`
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/shed-producer-model-scoping/_mill/briefs/review-code-holistic-r2.out.md`
