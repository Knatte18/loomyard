...
You are an independent code reviewer for **Producer gates: mechanical gates before session release**.
...
- `gate_attempts: 0` alongside no `gate:` key is silently accepted: **Location:** `internal/shedrecipe/entries_gate.go:51-56`
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/producer-gates`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=122)

- _mill/plan/00-overview.md
- _mill/plan/01-shuttle-gate-loop.md
- _mill/plan/02-seam-and-producers.md
- _mill/plan/03-loomshed-gates.md
- _mill/plan/04-shedrecipe-wiring.md
- _mill/plan/05-row-removal.md
- _mill/plan/06-parity-docs-sweep.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/producer-gates/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/producer-gates/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/producer-gates/_mill/briefs/review-code-holistic-r2.out.md`
