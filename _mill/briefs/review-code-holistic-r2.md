...
You are an independent code reviewer for **reed: AddStrand and attach self-heal a cold worktree**.
...
- New M1b scenario missing from the results checklist template: **Location:** `tools/sandbox/SANDBOX-REED-SUITE.md:115,490-491`
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/reed-cold-worktree-selfheal`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=56)

- _mill/plan/00-overview.md
- _mill/plan/01-engine-seam.md
- _mill/plan/02-attach-preflight.md
- _mill/plan/03-comment-sweep.md
- _mill/plan/04-docs-and-suites.md
- _mill/plan/05-tagged-tests.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/reed-cold-worktree-selfheal/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/reed-cold-worktree-selfheal/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/reed-cold-worktree-selfheal/_mill/briefs/review-code-holistic-r2.out.md`
