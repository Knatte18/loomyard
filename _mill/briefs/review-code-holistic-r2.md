...
You are an independent code reviewer for **Optimise and slim the rest of the test suite**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\01-gate-offline.md
- C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\02-board-fixtures.md
- C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\03-ide-fixtures.md
- C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\04-board-prune.md
- C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\05-docs.md
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\boardtest\doc.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\boardtest\integration_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\boardtest\git_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\boardtest\sync_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\git\git_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\ide\cli_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\ide\menu_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\lyxtest\lyxtest.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\sync.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\board.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\lyxtest\lyxtest_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\ide\cli.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\render.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\render_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\store.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\internal\board\store_test.go
- C:\Code\loomyard\wts\optimize-remaining-test-suites\docs\benchmarks\test-suite-timing.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\01-gate-offline.md`
  - `C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\02-board-fixtures.md`
  - `C:\Code\loomyard\wts\optimize-remaining-test-suites\_mill\plan\03-ide-fixtures.md`
