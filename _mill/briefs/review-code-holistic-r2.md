...
You are an independent code reviewer for **Reed and Fabric as standalone modules: public API design**.
...
- Mid-line semicolons left unbroken despite card 11's own verification pass: Location: manifest/designs/reed-fabric-standalone-api.md:61,105,172,194,197,207,271,487,488; nine lines joined two independent clauses with a mid-line semicolon instead of a semantic line break.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/reed-fabric-standalone-api-design`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=20)

- _mill/plan/00-overview.md
- _mill/plan/01-shared-frame-and-reed.md
- _mill/plan/02-fabric-creel-and-close.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/reed-fabric-standalone-api-design/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/reed-fabric-standalone-api-design/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/reed-fabric-standalone-api-design/_mill/briefs/review-code-holistic-r2.out.md`
