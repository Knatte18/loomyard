...
You are an independent code reviewer for **fabric: no remote/GitHub branch deletion**.
...
- Plan never named doc.go's chokepoint section as a location to amend: **Location:** `_mill/plan/02-fabricengine-remote-executor.md` card 4, `_mill/plan/03-engine-wiring.md` card 9
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/fabric-remote-branch-delete`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=62)

- _mill/plan/00-overview.md
- _mill/plan/01-gitrepo-remote-delete-primitive.md
- _mill/plan/02-fabricengine-remote-executor.md
- _mill/plan/03-engine-wiring.md
- _mill/plan/04-cli-surface-and-docs.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/fabric-remote-branch-delete/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/fabric-remote-branch-delete/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/fabric-remote-branch-delete/_mill/briefs/review-code-holistic-r2.out.md`
