...
You are an independent code reviewer for **reed: extract Selvage-pane lifecycle**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/reed-selvage-pane-extraction`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=24)

- _mill/plan/00-overview.md
- _mill/plan/01-selvagepane-extraction.md
- _mill/plan/02-docs-and-full-verification.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/reed-selvage-pane-extraction/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/reed-selvage-pane-extraction/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/reed-selvage-pane-extraction/_mill/briefs/review-code-holistic-r2.out.md`
