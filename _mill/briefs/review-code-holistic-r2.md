...
You are an independent code reviewer for **Extract internal/fsx and build internal/state**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\extract-internal-fsx\_mill\plan\00-overview.md
...
- C:\Code\loomyard\wts\extract-internal-fsx\internal\board\git.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\fsx\fsx.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\board\git_test.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\fsx\fsx_test.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\board\boardtest\integration_test.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\board\render.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\board\store.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\muxpoc\state.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\lock\lock.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\state\state.go
- C:\Code\loomyard\wts\extract-internal-fsx\internal\state\state_test.go
- C:\Code\loomyard\wts\extract-internal-fsx\docs\shared-libs\lock.md
- C:\Code\loomyard\wts\extract-internal-fsx\docs\shared-libs\README.md
- C:\Code\loomyard\wts\extract-internal-fsx\docs\shared-libs\fsx.md
- C:\Code\loomyard\wts\extract-internal-fsx\docs\shared-libs\state.md
- C:\Code\loomyard\wts\extract-internal-fsx\docs\roadmap.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\extract-internal-fsx\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\extract-internal-fsx\_mill\plan\01-fsx-package.md`
  - `C:\Code\loomyard\wts\extract-internal-fsx\_mill\plan\02-board-migration.md`
  - `C:\Code\loomyard\wts\extract-internal-fsx\_mill\plan\03-muxpoc-swap.md`
