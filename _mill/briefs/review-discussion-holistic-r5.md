...
You are an independent discussion reviewer for **native clients: migrate gitrepo to go-git + selfreport gh-CLI to go-github**. Round **5**. Reviewer model: **opushigh**.
