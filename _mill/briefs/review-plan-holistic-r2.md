...
You are an independent plan reviewer for **Fix failing TestRunCLI in internal/worktree**. You evaluate the complete plan (all batches) and produce a structured review.
