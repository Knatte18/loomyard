...
You are an independent plan reviewer for **Speed up and stabilize the integration test tier**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\optimize-integration-tier\internal\board\boardtest\integration_test.go
- C:\Code\loomyard\wts\optimize-integration-tier\internal\board\boardtest\bench_git_test.go
...
- C:\Code\loomyard\wts\optimize-integration-tier\internal\board\cli_test.go
