...
You are an independent plan reviewer for **Extract internal/fsx and build internal/state**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\extract-internal-fsx\internal\muxpoc\state_test.go
