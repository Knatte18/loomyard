...
You are an independent plan reviewer for **webster standalone mode: run refuses to start Master; logs write untracked into target repo**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/standalonegeom-webster-run-and-log-hygiene`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=38)

- _mill/plan/00-overview.md
- _mill/plan/01-shuttle-detached-runner.md
- _mill/plan/02-logs-dir-and-sink-api.md
- _mill/plan/03-standalone-wiring-and-docs.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/standalonegeom-webster-run-and-log-hygiene/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/standalonegeom-webster-run-and-log-hygiene/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/standalonegeom-webster-run-and-log-hygiene/_mill/briefs/review-plan-holistic-r2.out.md`
