...
You are an independent plan reviewer for **lyx loom step + external supervisor skill**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/loom-step`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=75)

- _mill/plan/00-overview.md
- _mill/plan/01-shedengine-step.md
- _mill/plan/02-loomshed-interrupt-policy.md
- _mill/plan/03-loomcli-shared-helpers.md
- _mill/plan/04-loom-step-verb.md
- _mill/plan/05-status-interrupt-policy.md
- _mill/plan/06-ly-plugin-supervise-skill.md
- _mill/plan/07-design-doc-and-roadmap.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/loom-step/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/loom-step/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/loom-step/_mill/briefs/review-plan-holistic-r2.out.md`
