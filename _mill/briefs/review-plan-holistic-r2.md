...
You are an independent plan reviewer for **weft engine: paths geometry, paired worktrees, lyx weft**. You evaluate the complete plan (all batches) and produce a structured review.
