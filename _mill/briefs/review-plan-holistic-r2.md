...
You are an independent plan reviewer for **Facilitate Linux support (Win11-side prep)**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\facilitate-linux\internal\muxengine\template.yaml
