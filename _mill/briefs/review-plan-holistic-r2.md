...
You are an independent plan reviewer for **fabric: close the corrindex two-phase read-modify-write race (slice 15)**.
...
- /home/hanf/Code/loomyard/wts/fabric-corrindex-record-race/manifest/designs/fabric-crucible-followups.md
...
Write your full report to this file: /home/hanf/Code/loomyard/wts/fabric-corrindex-record-race/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/loomyard/wts/fabric-corrindex-record-race/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/loomyard/wts/fabric-corrindex-record-race/_mill/briefs/review-plan-holistic-r2.out.md`
