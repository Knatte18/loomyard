# Holistic Fixer Brief — Rename loom CLI run/drive/step for verb/engine symmetry, plus rename ly-supervise
...
- **Holistic review file:** `/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/reviews/20260919-063436-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/loomyard/wts/loom-cli-rename`
...
```
/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/plan/01-go-cli-rename.md
/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/plan/02-launchers.md
/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/plan/03-go-comment-sweep.md
/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/plan/04-skill-rename.md
/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/plan/05-docs-and-manifest.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/reviews/20260919-063436-code-review-r1.md`.
...
Run each from `/home/knatte/Code/loomyard/wts/loom-cli-rename` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/loomyard/wts/loom-cli-rename rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made). Run `git -C /home/knatte/Code/loomyard/wts/loom-cli-rename status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"2bd45ddf-5081-420a-9d55-8d716bed213c"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `2bd45ddf-5081-420a-9d55-8d716bed213c` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"2bd45ddf-5081-420a-9d55-8d716bed213c"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
