# Holistic Fixer Brief — Adopt quarry's glyph alphabet as the plan alphabet
...
- **Holistic review file:** `/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/reviews/20260906-142111-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet`
...
```
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/01-quarry-dependency.md
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/02-planparser-alphabet.md
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/03-planparser-handles.md
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/04-planglyph.md
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/05-gate-parity.md
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/06-quarry-cli.md
/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/plan/07-webster-drift.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet/_mill/reviews/20260906-142111-code-review-r1.md`.
...
Run each from `/home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made). Run `git -C /home/knatte/Code/loomyard/wts/quarry-glyph-plan-alphabet status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"e2dcba93-4fd4-425b-ad61-f20431ea49ec"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `e2dcba93-4fd4-425b-ad61-f20431ea49ec` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"e2dcba93-4fd4-425b-ad61-f20431ea49ec"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
