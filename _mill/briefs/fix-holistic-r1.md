# Holistic Fixer Brief — Centralize glyph ref-shape enumeration
...
- **Holistic review file:** `/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/reviews/20260909-064741-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum`
...
```
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/01-registry-core.md
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/02-exported-surface.md
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/03-planparser-migration.md
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/04-planglyph-migration.md
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/05-status-family.md
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/06-batch-coverage.md
/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/plan/07-boundary-enforcement.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum/_mill/reviews/20260909-064741-code-review-r1.md`.
...
Run each from `/home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made), unless every finding was a legitimate --nits-only no-op requiring no code change. Run `git -C /home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"6b29a3ac-900f-42f7-9448-a9cb114b0094"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `6b29a3ac-900f-42f7-9448-a9cb114b0094` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"6b29a3ac-900f-42f7-9448-a9cb114b0094"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
...
Use `git -C /home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum` for commits;
do not `cd`.
...
- **If you need a file from the parent:** use `git -C /home/knatte/Code/loomyard/wts/centralize-glyph-shape-enum show <parent-branch>:<path>` to read it without changing cwd.
