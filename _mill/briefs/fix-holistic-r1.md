...
- **Holistic review file:** `C:\Code\loomyard\wts\rename-to-loomyard\_mill\reviews\20260616-122936-code-review-r1.md`
...
Load the **mill-receiving-review** skill before reading any finding in `C:\Code\loomyard\wts\rename-to-loomyard\_mill\reviews\20260616-122936-code-review-r1.md`. This is non-negotiable.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"d285e910-6370-43fb-9125-d20c1cde4ec0"}
```
...
**`session_id` MUST be exactly `d285e910-6370-43fb-9125-d20c1cde4ec0` (the UUID shown in the example above — it was injected into this brief when it was rendered). Copy it verbatim.**

or, when stuck:

```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"d285e910-6370-43fb-9125-d20c1cde4ec0"}
```
**Do not wrap the JSON in a code block. Output it as a bare line — no backticks, no fence. Anything other than a bare JSON line is treated as `stuck_type: logic`.**
