# Holistic Fixer Brief — Producer gates: mechanical gates before session release
...
- **Holistic review file:** `/home/knatte/Code/loomyard/wts/producer-gates/_mill/reviews/20260920-163644-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/loomyard/wts/producer-gates`
...
```
/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/01-shuttle-gate-loop.md
/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/02-seam-and-producers.md
/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/03-loomshed-gates.md
/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/04-shedrecipe-wiring.md
/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/05-row-removal.md
/home/knatte/Code/loomyard/wts/producer-gates/_mill/plan/06-parity-docs-sweep.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/loomyard/wts/producer-gates/_mill/reviews/20260920-163644-code-review-r1.md`.
...
Run each from `/home/knatte/Code/loomyard/wts/producer-gates` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/loomyard/wts/producer-gates rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made). Run `git -C /home/knatte/Code/loomyard/wts/producer-gates status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"de9757d0-4903-46c8-9aca-1330d8735914"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `de9757d0-4903-46c8-9aca-1330d8735914` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"de9757d0-4903-46c8-9aca-1330d8735914"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
