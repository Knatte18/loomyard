...
You are an independent code reviewer for **Extract shared infrastructure (config, git, lock)**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\mhgo\wts\extract-shared-infra\_mill\plan\00-overview.md
...
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\git.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\git\git.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\spawn_windows.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\git\git_windows.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\git\git_other.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\git\git_test.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\config.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\config\config.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\config_test.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\config\config_test.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\board.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\store.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\sync.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\spawn_other.go
- C:\Code\mhgo\wts\extract-shared-infra\internal\board\init.go

## Plan + source files to review
- Overview: `C:\Code\mhgo\wts\extract-shared-infra\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\mhgo\wts\extract-shared-infra\_mill\plan\01-internal-lock.md`
  - `C:\Code\mhgo\wts\extract-shared-infra\_mill\plan\02-internal-git.md`
  - `C:\Code\mhgo\wts\extract-shared-infra\_mill\plan\03-internal-config.md`
