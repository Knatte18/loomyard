...
You are an independent code reviewer for **Reconcile stale design docs (stateless + weft model)**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\reconcile-stale-docs\docs\research\mux-exploration.md
- C:\Code\loomyard\wts\reconcile-stale-docs\docs\research\mux-hooks-exploration.md
- C:\Code\loomyard\wts\reconcile-stale-docs\docs\research\mux-proposal.md
- C:\Code\loomyard\wts\reconcile-stale-docs\docs\reference\psmux_scripting.md
