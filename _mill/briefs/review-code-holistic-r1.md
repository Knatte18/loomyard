...
You are an independent code reviewer for **Board fixes from sandbox run — payload keys, help, rerender**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\board-sandbox-fixes\internal\board\boardtest\bench_test.go
- C:\Code\loomyard\wts\board-sandbox-fixes\cmd\lyx\main_test.go
...
- C:\Code\loomyard\wts\board-sandbox-fixes\internal\board\help_test.go
