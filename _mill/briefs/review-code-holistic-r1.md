...
You are an independent code reviewer for **Harden the Path Invariant: close enforcement hole + fix geometry leaks**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\01-paths-foundation.md
- C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\02-warp-geometry.md
- C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\03-board-paths-owned.md
- C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\04-lyxtest-geometry.md
- C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\05-enforcement-and-docs.md
- C:\Code\loomyard\wts\harden-path-invariant\internal\paths\enforcement_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\paths\paths.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\warpengine\prune.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\paths\paths_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\paths\weft_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\paths\paths_unit_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\paths\geometry_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\warpengine\reconcile.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\warpengine\status.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\warpengine\clone.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\warpcli\clone.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\warpengine\clone_integration_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardengine\template.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardengine\template.yaml
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardengine\board.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardengine\config.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\clihelp\exec.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardcli\cli.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardengine\template_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardengine\config_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\boardcli\cli_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\configsync\configsync.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\yamlengine\reconcile.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\configsync\configsync_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\lyxtest\lyxtest_test.go
- C:\Code\loomyard\wts\harden-path-invariant\internal\lyxtest\lyxtest.go
- C:\Code\loomyard\wts\harden-path-invariant\cmd\lyx\registration_test.go
- C:\Code\loomyard\wts\harden-path-invariant\cmd\lyx\main_test.go
- C:\Code\loomyard\wts\harden-path-invariant\CONSTRAINTS.md
- C:\Code\loomyard\wts\harden-path-invariant\docs\shared-libs\paths.md
- C:\Code\loomyard\wts\harden-path-invariant\docs\shared-libs\yamlengine.md
- C:\Code\loomyard\wts\harden-path-invariant\docs\shared-libs\configengine.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\01-paths-foundation.md`
  - `C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\02-warp-geometry.md`
  - `C:\Code\loomyard\wts\harden-path-invariant\_mill\plan\03-board-paths-owned.md`
