...
You are an independent code reviewer for **Speed up git-fixture tests: bench, analyse, hardlink**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\01-retier-builder-tests.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\02-hermetic-lyxtest.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\03-testmains-and-guard.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\04-bench-and-docs.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\cmd\lyx\tierpurity_test.go
...
- C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\discussion.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\lyxtest\lyxtest.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\lyxtest\doc.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\lyxtest\hermetic.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\lyxtest\lyxtest_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\CONSTRAINTS.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\cmd\lyx\hermeticenv_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\warpengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\warpcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\weftengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\weftcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\boardcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\boardengine\boardtest\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\buildercli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\builderengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\perchcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\perchengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\muxcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\muxpoccli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\shuttlecli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\burlerengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\initengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\initcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\configcli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\idecli\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\ideengine\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\hubgeometry\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\gitexec\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\cmd\lyx\testmain_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\boardengine\boardtest\bench_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\lyxtest\bench_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\cmd\testtiming\main.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\docs\benchmarks\fixture-copy.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\buildercli\testdata_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\buildercli\pause_spawnbatch_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\docs\benchmarks\test-suite-timing.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\docs\benchmarks\running-tests.md
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\buildercli\poll_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\buildercli\status_test.go
- C:\Code\loomyard\wts\faster-git-fixture-tests\internal\buildercli\pause_test.go

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\01-retier-builder-tests.md`
  - `C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\02-hermetic-lyxtest.md`
  - `C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\plan\03-testmains-and-guard.md`
...
Write your full report to this file: C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\briefs\review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\briefs\review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\faster-git-fixture-tests\_mill\briefs\review-code-holistic-r1.out.md`
