...
You are an independent code reviewer for **Custom-typed plan cards skip path-missing checks**.
...
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/00-overview.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/01-planparser-model-and-parse.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/02-group-scoped-validation.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/03-format-contract-sweep.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/plan.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/parse.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/parse_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/normalize.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/normalize_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/validate.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/validate_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/testdata/goodplan/02-json-flag.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/specs/loom-plan-spec.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/stencils/loom/loom-template-plan.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/loomengine/plan_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/stencils/loom/loom-rubric-plan-review.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/stencils/loom/loom-rubric-webster-review.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/stencils/webster/webster-body-implementer.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/recipes/loom-recipe.yaml
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/manifest/designs/loom.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/manifest/designs/plan-card-format.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/manifest/designs/scout-plan-symbol-fields.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/tools/sandbox/SANDBOX-WEBSTER-SUITE.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/webstercli/validate.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/doc.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/loomshed/planvalidate_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/loomrecipe/fixture_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/websterengine/runlevel_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/websterengine/sequence_test.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/classify.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/testdata/goodplan/00-overview.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/planparser/testdata/goodplan/03-json-emission.md
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/internal/loomengine/plan.go
- /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/contracts/stencils/rubric_test.go

## Plan + source files to review
- Overview: `/home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/01-planparser-model-and-parse.md`
  - `/home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/02-group-scoped-validation.md`
  - `/home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/plan/03-format-contract-sweep.md`
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/plan-custom-card-skips-path-check/_mill/briefs/review-code-holistic-r1.out.md`
