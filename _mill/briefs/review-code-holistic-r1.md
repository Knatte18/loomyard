...
You are an independent code reviewer for **Add Effort to shuttle's run Spec**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\shuttle-spec-effort\_mill\plan\00-overview.md
...
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\command.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\spec.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\spec_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\claudeengine.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\command_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\config.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\prepare_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttlecli\run.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttlecli\cli_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\docs\overview.md
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\events.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\wait.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\fakes_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\engine.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\events_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\settings.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\claudeengine\settings_test.go
- C:\Code\loomyard\wts\shuttle-spec-effort\internal\shuttleengine\wait_test.go

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\shuttle-spec-effort\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\shuttle-spec-effort\_mill\plan\01-effort.md`
  - `C:\Code\loomyard\wts\shuttle-spec-effort\_mill\plan\02-ask-signal.md`
