...
You are an independent code reviewer for **internal/paths: subpath init + mirrored system dirs**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\00-overview.md
- C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\01-paths-geometry.md
- C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\02-worktree-consumers.md
- C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\03-docs.md
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\paths\enforcement_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\paths\paths.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\launchers.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\paths\helpers_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\paths\paths_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\paths\codeguide_guard_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\links.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\remove.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\prune.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\prune_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\junction_windows.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\junction_other.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\portals.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\testhelpers_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\portals_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\internal\worktree\launchers_test.go
- C:\Code\mhgo\wts\paths-subpath-mirroring\CONSTRAINTS.md
- C:\Code\mhgo\wts\paths-subpath-mirroring\docs\shared-libs\paths.md

## Plan + source files to review
- Overview: `C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\01-paths-geometry.md`
  - `C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\02-worktree-consumers.md`
  - `C:\Code\mhgo\wts\paths-subpath-mirroring\_mill\plan\03-docs.md`
