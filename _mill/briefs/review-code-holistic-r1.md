...
You are an independent code reviewer for **Crucible review spawn as effort-selectable Agent profiles**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- **Enforced by** review obligation: agent prompt templates never instruct a weft git op, and weft git stays inside `internal/fabricengine`. The module-ownership half is a candidate for a future import/grep guard; not machine-checked today.
...
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\plan\01-effort-profiles-and-crucible-rewiring.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\discussion.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\crucible\review-prompt-template.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\CONSTRAINTS.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\.claude\agents\crucible-reviewer-low.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\.claude\agents\crucible-reviewer-medium.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\.claude\agents\crucible-reviewer-high.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\.claude\agents\crucible-reviewer-xhigh.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\.claude\agents\crucible-reviewer-max.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\crucible\README.md
- C:\Code\loomyard\wts\crucible-effort-agent-profiles\crucible\orchestrator-prompt.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\plan\01-effort-profiles-and-crucible-rewiring.md`
...
Write your full report to this file: C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\briefs\review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\briefs\review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\crucible-effort-agent-profiles\_mill\briefs\review-code-holistic-r1.out.md`
