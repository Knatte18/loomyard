...
You are an independent code reviewer for **Rename loom CLI run/drive/step for verb/engine symmetry, plus rename ly-supervise**.
...
- _mill/plan/02-launchers.md
- _mill/plan/03-go-comment-sweep.md
- _mill/plan/04-skill-rename.md
- _mill/plan/05-docs-and-manifest.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/loom-cli-rename/_mill/briefs/review-code-holistic-r1.out.md`
