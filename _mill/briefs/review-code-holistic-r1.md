...
You are an independent code reviewer for **Rename hub container suffix from -HUB to -LYXHUB**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/hub-suffix-lyxhub`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=68)

- _mill/plan/00-overview.md
- _mill/plan/01-core-constants.md
- _mill/plan/02-production-prose.md
- _mill/plan/03-fabricengine-tests.md
- _mill/plan/04-peripheral-tests.md
- _mill/plan/05-sandbox-fixture.md
- _mill/plan/06-docs-prose.md
- _mill/plan/07-final-sweep-gate.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/hub-suffix-lyxhub/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/hub-suffix-lyxhub/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/hub-suffix-lyxhub/_mill/briefs/review-code-holistic-r1.out.md`
