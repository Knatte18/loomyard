...
You are an independent code reviewer for **Fix stale .mhgo/ config-layer docs + cross-cutting stale-docs sweep**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\00-overview.md
- C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\01-board-config-fixes.md
- C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\02-muxpoc-doc.md
- C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\03-tree-sweep.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\shared-libs\config.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\modules\worktree.md
- C:\Code\mhgo\wts\docs-stale-sweep\internal\config\config.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\board\config.go
- C:\Code\mhgo\wts\docs-stale-sweep\docs\modules\board.md
- C:\Code\mhgo\wts\docs-stale-sweep\internal\worktree\cli.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\board\cli.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\worktree\config.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\cli.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\cmd.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\state.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\up.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\daemon.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\review.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\attach.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\status.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\down.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\spawn_windows.go
- C:\Code\mhgo\wts\docs-stale-sweep\internal\muxpoc\spawn_other.go
- C:\Code\mhgo\wts\docs-stale-sweep\cmd\mhgo\main.go
- C:\Code\mhgo\wts\docs-stale-sweep\docs\modules\mux.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\shared-libs\state.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\modules\muxpoc.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\roadmap.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\overview.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\shared-libs\README.md
- C:\Code\mhgo\wts\docs-stale-sweep\docs\benchmarks.md

## Plan + source files to review
- Overview: `C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\01-board-config-fixes.md`
  - `C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\02-muxpoc-doc.md`
  - `C:\Code\mhgo\wts\docs-stale-sweep\_mill\plan\03-tree-sweep.md`
