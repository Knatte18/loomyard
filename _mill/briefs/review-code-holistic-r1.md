...
You are an independent code reviewer for **Bump quarry to v0.2.0 and adopt Status.Known()/Rejected()**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/quarry-bump-v0-2-0-status-helpers`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=16)

- _mill/plan/00-overview.md
- _mill/plan/01-quarry-bump-and-adoption.md
- go.mod
- go.sum
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/quarry-bump-v0-2-0-status-helpers/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/quarry-bump-v0-2-0-status-helpers/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/quarry-bump-v0-2-0-status-helpers/_mill/briefs/review-code-holistic-r1.out.md`
