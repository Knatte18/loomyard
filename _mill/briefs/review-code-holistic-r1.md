...
You are an independent code reviewer for **Restore the Tier 1 floor: guards + perchengine**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\restore-tier1-floor\_mill\plan\00-overview.md
...
- C:\Code\loomyard\wts\restore-tier1-floor\cmd\lyx\main.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\clihelp\exec.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\perchengine\gate.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\perchengine\testmain_test.go
- C:\Code\loomyard\wts\restore-tier1-floor\cmd\lyx\tierpurity_test.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\perchengine\gate_test.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\perchengine\gate_lingering_test.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\boardengine\boardtest\bench_test.go
- C:\Code\loomyard\wts\restore-tier1-floor\internal\boardengine\boardtest\concurrency_test.go
- C:\Code\loomyard\wts\restore-tier1-floor\cmd\testtiming\main.go
- C:\Code\loomyard\wts\restore-tier1-floor\_mill\discussion.md
- C:\Code\loomyard\wts\restore-tier1-floor\docs\benchmarks\test-suite-timing.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\restore-tier1-floor\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\restore-tier1-floor\_mill\plan\01-code-fixes.md`
  - `C:\Code\loomyard\wts\restore-tier1-floor\_mill\plan\02-benchmarks-block.md`
...
Write your full report to this file: C:\Code\loomyard\wts\restore-tier1-floor\_mill\briefs\review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\restore-tier1-floor\_mill\briefs\review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\restore-tier1-floor\_mill\briefs\review-code-holistic-r1.out.md`
