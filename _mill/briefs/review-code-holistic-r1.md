...
You are an independent code reviewer for **webster: stop re-rendering already-inherited context into fork prompts**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/loomyard/wts/webster-fork-context-hygiene/internal/websterengine/implementer-body.md
- /home/knatte/Code/loomyard/wts/webster-fork-context-hygiene/internal/websterengine/fork-prefix.md
- /home/knatte/Code/loomyard/wts/webster-fork-context-hygiene/internal/websterengine/recovery-prefix.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/webster-fork-context-hygiene/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/webster-fork-context-hygiene/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/webster-fork-context-hygiene/_mill/briefs/review-code-holistic-r1.out.md`
