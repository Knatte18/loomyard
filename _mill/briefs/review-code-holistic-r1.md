...
You are an independent code reviewer for **Formalize the Tier 1/2 substrate rule and re-tier mis-tagged tests**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/loomyard/wts/test-tier-substrate-audit/cmd/lyx/tiersleep_test.go
...
- /home/knatte/Code/loomyard/wts/test-tier-substrate-audit/internal/scoutengine/supervised_scout_test.go
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/test-tier-substrate-audit/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/test-tier-substrate-audit/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/test-tier-substrate-audit/_mill/briefs/review-code-holistic-r1.out.md`
