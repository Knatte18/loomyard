...
You are an independent code reviewer for **Worktree spawn/teardown as Shed producers**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/worktree-lifecycle-shed-producers`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=117)

- _mill/plan/00-overview.md
- _mill/plan/01-lifecycleshed-producers.md
- _mill/plan/02-shedrecipe-entries.md
- _mill/plan/03-lifecycle-recipe-and-coverage.md
- _mill/plan/04-loom-run-no-attach.md
- _mill/plan/05-lifecyclecli-module.md
- _mill/plan/06-registration-and-docs.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/worktree-lifecycle-shed-producers/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/worktree-lifecycle-shed-producers/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/worktree-lifecycle-shed-producers/_mill/briefs/review-code-holistic-r1.out.md`
