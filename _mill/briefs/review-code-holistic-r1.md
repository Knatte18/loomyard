...
You are an independent code reviewer for **self-report Tier 2: per-agent friction notes for unsupervised runs**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/self-report-tier2`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=111)

- _mill/plan/00-overview.md
- _mill/plan/01-friction-leaf.md
- _mill/plan/02-loom-paths-and-config.md
- _mill/plan/03-frictionengine.md
- _mill/plan/04-compose-loom.md
- _mill/plan/05-compose-burler.md
- _mill/plan/06-compose-webster.md
- _mill/plan/07-wiring.md
- _mill/plan/08-docs.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/self-report-tier2/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/self-report-tier2/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/self-report-tier2/_mill/briefs/review-code-holistic-r1.out.md`
