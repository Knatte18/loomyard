...
You are an independent code reviewer for **Shed-generic watchdog for ly-drive and loom's CLI verbs**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/shed-generic-watchdog`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=131)

- _mill/plan/00-overview.md
- _mill/plan/01-shedbuild-shedpaths-hoist.md
- _mill/plan/02-inner-run-neutralization.md
- _mill/plan/03-shedverbs-package.md
- _mill/plan/04-module-rearm.md
- _mill/plan/05-shed-subtree.md
- _mill/plan/06-docs-invariant-skill.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/shed-generic-watchdog/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/shed-generic-watchdog/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/shed-generic-watchdog/_mill/briefs/review-code-holistic-r1.out.md`
