...
You are an independent code reviewer for **Build modelspec - the model-spec parser + registry**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\modelspec\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\modelspec\_mill\plan\01-modelspec-core.md
- C:\Code\loomyard\wts\modelspec\_mill\plan\02-models-registration.md
- C:\Code\loomyard\wts\modelspec\_mill\plan\03-shuttle-version.md
- C:\Code\loomyard\wts\modelspec\docs\reference\model-spec.md
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\spec.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\modelspec.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\parse.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\parse_test.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\registry.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\registry_test.go
- C:\Code\loomyard\wts\modelspec\internal\hubgeometry\hubgeometry.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\load.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\load_test.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\template.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\template.yaml
- C:\Code\loomyard\wts\modelspec\internal\modelspec\template.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\template.yaml
- C:\Code\loomyard\wts\modelspec\internal\modelspec\template_test.go
- C:\Code\loomyard\wts\modelspec\internal\lyxtest\leaf_enforcement_test.go
- C:\Code\loomyard\wts\modelspec\internal\modelspec\leaf_enforcement_test.go
- C:\Code\loomyard\wts\modelspec\docs\roadmap.md
- C:\Code\loomyard\wts\modelspec\CONSTRAINTS.md
- C:\Code\loomyard\wts\modelspec\docs\overview.md
- C:\Code\loomyard\wts\modelspec\docs\shared-libs\README.md
- C:\Code\loomyard\wts\modelspec\internal\configsync\configsync.go
- C:\Code\loomyard\wts\modelspec\internal\configcli\configcli.go
- C:\Code\loomyard\wts\modelspec\internal\configreg\configreg.go
- C:\Code\loomyard\wts\modelspec\internal\configreg\configreg_test.go
- C:\Code\loomyard\wts\modelspec\internal\yamlengine\reconcile.go
- C:\Code\loomyard\wts\modelspec\internal\configsync\configsync_test.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\spec_test.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\engine.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\claudeengine\claudeengine.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\claudeengine\command.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\claudeengine\command_test.go
- C:\Code\loomyard\wts\modelspec\internal\shuttleengine\claudeengine\prepare_test.go

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\modelspec\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\modelspec\_mill\plan\01-modelspec-core.md`
  - `C:\Code\loomyard\wts\modelspec\_mill\plan\02-models-registration.md`
  - `C:\Code\loomyard\wts\modelspec\_mill\plan\03-shuttle-version.md`
