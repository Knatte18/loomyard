...
You are an independent code reviewer for **reed: resume/down leak lock directories at the stale pre-rename session-name path**.
...
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/plan/00-overview.md
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/plan/01-refuse-a-vanished-worktree-root.md
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/plan/02-watch-loop-dormant-mode.md
...
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/watchdog.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/watchloop.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/watchloop_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/geometry.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/hubgeom/hubgeom.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/standalonegeom/reedgeom.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/standalonestate/standalonestate.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/CONSTRAINTS.md
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/contract_integration_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/mouse_boot_integration_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/watchdog_integration_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/attachgeometry_integration_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/header_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/reapply.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/lyxdirs/dirs.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/reedengine/reapply_test.go
- /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/internal/logger/logger.go

## Plan + source files to review
- Overview: `/home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/plan/01-refuse-a-vanished-worktree-root.md`
  - `/home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/plan/02-watch-loop-dormant-mode.md`
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/reed-lock-stale-session-name/_mill/briefs/review-code-holistic-r1.out.md`
