...
You are an independent code reviewer for **Dedicated sandbox suite for mux**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- **Tagging.** A scenario in **any** suite file matching
  ...
  `MUX-SANDBOX-SUITE.md`) that drives a specific module declares it with a
...
- C:\Code\loomyard\wts\mux-sandbox-suite\_mill\plan\00-overview.md
...
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\SANDBOX-SUITE.md
- C:\Code\loomyard\wts\mux-sandbox-suite\docs\modules\mux.md
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\MUX-SANDBOX-SUITE.md
- C:\Code\loomyard\wts\mux-sandbox-suite\cmd\lyx\registration_test.go
- C:\Code\loomyard\wts\mux-sandbox-suite\cmd\lyx\sandbox_coverage_test.go
- C:\Code\loomyard\wts\mux-sandbox-suite\CONSTRAINTS.md
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\report.go
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\suite.go
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\main.go
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\suite_test.go
- C:\Code\loomyard\wts\mux-sandbox-suite\tools\sandbox\main_test.go
- C:\Code\loomyard\wts\mux-sandbox-suite\sandbox-suite.cmd
- C:\Code\loomyard\wts\mux-sandbox-suite\mux-sandbox-suite.cmd
- C:\Code\loomyard\wts\mux-sandbox-suite\sandbox-fetch.cmd
- C:\Code\loomyard\wts\mux-sandbox-suite\docs\sandbox-howto.md
- C:\Code\loomyard\wts\mux-sandbox-suite\docs\sandbox-hub.md
- C:\Code\loomyard\wts\mux-sandbox-suite\docs\overview.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\mux-sandbox-suite\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\mux-sandbox-suite\_mill\plan\01-suite-doc-and-guard.md`
  - `C:\Code\loomyard\wts\mux-sandbox-suite\_mill\plan\02-mux-suite-launcher.md`
  - `C:\Code\loomyard\wts\mux-sandbox-suite\_mill\plan\03-docs.md`
