...
You are an independent code reviewer for **Unify webster/burler CLI wiring into a shared module**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/unify-webster-burler-wiring`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=43)

- _mill/plan/00-overview.md
- _mill/plan/01-cliwire-package.md
- _mill/plan/02-rewire-clis.md
- _mill/plan/03-enforcement-and-docs.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/unify-webster-burler-wiring/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/unify-webster-burler-wiring/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/unify-webster-burler-wiring/_mill/briefs/review-code-holistic-r1.out.md`
