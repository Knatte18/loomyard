...
You are an independent code reviewer for **Speed up internal/warp integration tests**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\01-fixture-hook-strip.md
- C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\02-add-weftwiring.md
- C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\03-drift-status.md
- C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\04-prune-cleanup.md
- C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\05-remove-hook-misc.md
- C:\Code\loomyard\wts\warp-test-speedup\CONSTRAINTS.md
- C:\Code\loomyard\wts\warp-test-speedup\internal\lyxtest\lyxtest.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\paths\paths.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\fslink\fslink.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\weftwiring.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\add_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\weftwiring_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\drift_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\status_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\prune_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\cleanup_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\remove_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\hook_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\list_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\warp_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\launchers_test.go
- C:\Code\loomyard\wts\warp-test-speedup\internal\warp\portals_test.go

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\01-fixture-hook-strip.md`
  - `C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\02-add-weftwiring.md`
  - `C:\Code\loomyard\wts\warp-test-speedup\_mill\plan\03-drift-status.md`
