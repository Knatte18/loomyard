...
You are an independent code reviewer for **reed: born-as-strand for loom start's operator attach**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/reed-born-as-strand`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=40)

- _mill/plan/00-overview.md
- _mill/plan/01-watchdog-seam-and-focus-pin.md
- _mill/plan/02-operator-strand-and-loom-wiring.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/reed-born-as-strand/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/reed-born-as-strand/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/reed-born-as-strand/_mill/briefs/review-code-holistic-r1.out.md`
