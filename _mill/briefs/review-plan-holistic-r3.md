...
You are an independent plan reviewer for **native clients: migrate gitrepo to go-git + selfreport gh-CLI to go-github**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\03-migrate-core-reads.md
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\04-migrate-snapshot-push-reads.md
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\05-retire-poc-and-measure.md
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\06-githubclient.md
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\07-selfreport-transport.md
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\08-guards.md
- C:\Code\loomyard\wts\native-clients-migration\_mill\plan\09-docs-and-invariants.md
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\gitnativepoc.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\doc.go
- C:\Code\loomyard\wts\native-clients-migration\.scratch\gogit-worktree-probe-report.md
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\gitrepo.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\snapshot.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\push.go
- C:\Code\loomyard\wts\native-clients-migration\.scratch\gogit-probe-report.md
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\gitrepo_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\testmain_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\fslink\fslink.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\keyvalidation_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitexec\gitexec.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\harness_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\read_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\read.go
- C:\Code\loomyard\wts\native-clients-migration\internal\boardengine\sync.go
- C:\Code\loomyard\wts\native-clients-migration\internal\fabricengine\weftgit.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\doc.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\write.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\write_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitnativepoc\testmain_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\fabricengine\fabric.go
- C:\Code\loomyard\wts\native-clients-migration\internal\websterengine\gitwrap.go
- C:\Code\loomyard\wts\native-clients-migration\internal\websterengine\integration.go
- C:\Code\loomyard\wts\native-clients-migration\internal\websterengine\runlevel.go
- C:\Code\loomyard\wts\native-clients-migration\internal\fabriccli\spawn.go
- C:\Code\loomyard\wts\native-clients-migration\internal\selfreportengine\selfreport.go
- C:\Code\loomyard\wts\native-clients-migration\go.mod
- C:\Code\loomyard\wts\native-clients-migration\go.sum
- C:\Code\loomyard\wts\native-clients-migration\internal\proc\proc_windows.go
- C:\Code\loomyard\wts\native-clients-migration\internal\fslink\fslink_windows.go
- C:\Code\loomyard\wts\native-clients-migration\internal\modelspec\leaf_enforcement_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\tokenvocab\leaf_enforcement_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\selfreportcli\cli.go
- C:\Code\loomyard\wts\native-clients-migration\internal\selfreportcli\cli_test.go
- C:\Code\loomyard\wts\native-clients-migration\CONSTRAINTS.md
- C:\Code\loomyard\wts\native-clients-migration\cmd\lyx\sandbox_coverage_test.go
- C:\Code\loomyard\wts\native-clients-migration\tools\sandbox\resolve.go
- C:\Code\loomyard\wts\native-clients-migration\tools\sandbox\pathresolve_guard_test.go
- C:\Code\loomyard\wts\native-clients-migration\cmd\lyx\tierpurity_test.go
- C:\Code\loomyard\wts\native-clients-migration\cmd\lyx\longlist_test.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\pull.go
- C:\Code\loomyard\wts\native-clients-migration\internal\gitrepo\reset.go
- C:\Code\loomyard\wts\native-clients-migration\docs\overview.md
- C:\Code\loomyard\wts\native-clients-migration\README.md
- C:\Code\loomyard\wts\native-clients-migration\manifest\roadmap.md
- C:\Code\loomyard\wts\native-clients-migration\manifest\designs\native-clients-migration.md
- C:\Code\loomyard\wts\native-clients-migration\cmd\lyx\hermeticenv_test.go

## Plan files to review
- Overview: `C:\Code\loomyard\wts\native-clients-migration\_mill\plan\00-overview.md`
- Batches:
- `C:\Code\loomyard\wts\native-clients-migration\_mill\plan\01-gogit-handle.md`
- `C:\Code\loomyard\wts\native-clients-migration\_mill\plan\02-parity-oracle.md`
- `C:\Code\loomyard\wts\native-clients-migration\_mill\plan\03-migrate-core-reads.md`
...
Write your full report to this file: C:\Code\loomyard\wts\native-clients-migration\_mill\briefs\review-plan-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\native-clients-migration\_mill\briefs\review-plan-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\native-clients-migration\_mill\briefs\review-plan-holistic-r3.out.md`
