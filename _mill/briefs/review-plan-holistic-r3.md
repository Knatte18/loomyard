...
You are an independent plan reviewer for **llm-driven child can park forever on Claude Code's own workspace-trust dialog**.
...
Every unprefixed path below is relative to `/home/hanf/Code/loomyard/wts/llm-driver-trust-dialog-hang`.
- `wiki/` paths are relative to `/home/hanf/Code/loomyard/wiki`

## Files included (N=22)

- _mill/plan/00-overview.md
- _mill/plan/01-shuttle-await-started.md
- _mill/plan/02-loom-llm-arm-readiness.md
...
Write your full report to this file: /home/hanf/Code/loomyard/wts/llm-driver-trust-dialog-hang/_mill/briefs/review-plan-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/loomyard/wts/llm-driver-trust-dialog-hang/_mill/briefs/review-plan-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/loomyard/wts/llm-driver-trust-dialog-hang/_mill/briefs/review-plan-holistic-r3.out.md`
