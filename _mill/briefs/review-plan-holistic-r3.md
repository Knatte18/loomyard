...
You are an independent plan reviewer for **Loom persists done only after post-run friction reflection**.
...
Every unprefixed path below is relative to `/home/knatte/Code/loomyard/wts/loom-done-after-friction`.
- `wiki/` paths are relative to `/home/knatte/Code/loomyard/wiki`

## Files included (N=59)

- _mill/plan/00-overview.md
- _mill/plan/01-friction-reflect-row.md
- _mill/plan/02-loomcli-row-wiring.md
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/loom-done-after-friction/_mill/briefs/review-plan-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/loom-done-after-friction/_mill/briefs/review-plan-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/loom-done-after-friction/_mill/briefs/review-plan-holistic-r3.out.md`
