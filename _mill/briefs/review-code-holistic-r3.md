...
You are an independent code reviewer for **weft producers: _lyx/config, lyx config, codeguide**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- `os.Chdir` used directly instead of `t.Chdir` in integration test: **Location:** `C:\Code\loomyard\wts\weft-producers\internal\configcli\configcli_integration_test.go:53-56`
- Overview `docs/overview.md` code block does not show `config` dispatch case: **Location:** `C:\Code\loomyard\wts\weft-producers\docs\overview.md:162-177`
...
- C:\Code\loomyard\wts\weft-producers\internal\board\template.go
- C:\Code\loomyard\wts\weft-producers\internal\worktree\config.go
- C:\Code\loomyard\wts\weft-producers\internal\worktree\template.go
- C:\Code\loomyard\wts\weft-producers\internal\weft\config.go
- C:\Code\loomyard\wts\weft-producers\internal\weft\template.go
- C:\Code\loomyard\wts\weft-producers\internal\board\init_test.go
- C:\Code\loomyard\wts\weft-producers\internal\board\template_test.go
- C:\Code\loomyard\wts\weft-producers\internal\worktree\template_test.go
- C:\Code\loomyard\wts\weft-producers\internal\weft\template_test.go
...
- C:\Code\loomyard\wts\weft-producers\internal\config\edit.go
- C:\Code\loomyard\wts\weft-producers\internal\config\config_test.go
- C:\Code\loomyard\wts\weft-producers\internal\config\edit_test.go
- C:\Code\loomyard\wts\weft-producers\internal\configcli\configcli.go
...
- C:\Code\loomyard\wts\weft-producers\internal\configcli\menu.go
...
- C:\Code\loomyard\wts\weft-producers\internal\configcli\configcli_test.go
- C:\Code\loomyard\wts\weft-producers\internal\configcli\configcli_integration_test.go
