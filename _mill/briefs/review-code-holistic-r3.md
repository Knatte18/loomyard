...
You are an independent code reviewer for **Add typed file-ops to lyx's plan-format**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- Batch 4's depends-on: [1] understates its real dependency on batch 2: Location: _mill/plan/00-overview.md:32-36, _mill/plan/04-templates-help.md:9
...
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\00-overview.md
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\01-parser-v2.md
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\02-move-checks.md
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\03-card-checks.md
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\04-templates-help.md
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\05-docs.md
- C:\Code\loomyard\wts\plan-format-file-ops\_mill\discussion.md
- C:\Code\loomyard\wts\plan-format-file-ops\docs\modules\plan-format.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\plan.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\validate.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\doc.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\fingerprint.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-valid\00-overview.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-valid\01-json-flag.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-valid\02-list-tests.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-valid\03-refactor-a.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-valid\04-refactor-b.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-valid\05-oversized.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-unapproved\00-overview.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-unapproved\01-only.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-broken-chain\00-overview.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-broken-chain\01-first.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\testdata\plan-broken-chain\02-second.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\plan_test.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\validate_test.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\runlevel_test.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\digest.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\spawn.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\implementer-template.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\template_test.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\builderengine\orchestrator-template.md
- C:\Code\loomyard\wts\plan-format-file-ops\internal\buildercli\cli_test.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\buildercli\cli.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\buildercli\validate.go
- C:\Code\loomyard\wts\plan-format-file-ops\internal\buildercli\validate_test.go
- C:\Code\loomyard\wts\plan-format-file-ops\docs\modules\builder.md
- C:\Code\loomyard\wts\plan-format-file-ops\docs\overview.md
- C:\Code\loomyard\wts\plan-format-file-ops\docs\reference\model-spec.md
- C:\Code\loomyard\wts\plan-format-file-ops\tools\sandbox\SANDBOX-CORE-SUITE.md

## Plan + source files to review
- Overview: `C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\01-parser-v2.md`
  - `C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\02-move-checks.md`
  - `C:\Code\loomyard\wts\plan-format-file-ops\_mill\plan\03-card-checks.md`
