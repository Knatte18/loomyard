...
You are an independent code reviewer for **board-modul (rename fra wiki) + _mhgo-konfigurasjon**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\mhgo\wts\config-layer\internal\board\board.go
- C:\Code\mhgo\wts\config-layer\internal\board\board_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\cli.go
- C:\Code\mhgo\wts\config-layer\internal\board\cli_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\git.go
- C:\Code\mhgo\wts\config-layer\internal\board\git_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\layer.go
- C:\Code\mhgo\wts\config-layer\internal\board\layer_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\lock.go
- C:\Code\mhgo\wts\config-layer\internal\board\lock_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\render.go
- C:\Code\mhgo\wts\config-layer\internal\board\render_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\spawn_other.go
- C:\Code\mhgo\wts\config-layer\internal\board\spawn_windows.go
- C:\Code\mhgo\wts\config-layer\internal\board\store.go
- C:\Code\mhgo\wts\config-layer\internal\board\store_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\sync.go
- C:\Code\mhgo\wts\config-layer\internal\board\sync_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\task.go
- C:\Code\mhgo\wts\config-layer\internal\board\task_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\boardtest\bench_git_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\boardtest\bench_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\boardtest\concurrency_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\boardtest\doc.go
- C:\Code\mhgo\wts\config-layer\internal\board\boardtest\integration_test.go
- C:\Code\mhgo\wts\config-layer\go.sum
- C:\Code\mhgo\wts\config-layer\internal\board\config.go
- C:\Code\mhgo\wts\config-layer\internal\board\config_test.go
- C:\Code\mhgo\wts\config-layer\internal\board\init.go
- C:\Code\mhgo\wts\config-layer\internal\board\init_test.go
- C:\Code\mhgo\wts\config-layer\docs\board.md
...
- C:\Code\mhgo\wts\config-layer\docs\roadmap.md
