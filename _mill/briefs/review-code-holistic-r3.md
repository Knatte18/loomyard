...
- SANDBOX-CORE-SUITE.md's scenario-id range and session log are stale after S7/S8 deletion: `tools/sandbox/SANDBOX-CORE-SUITE.md:113,344-345`
- SANDBOX-FABRIC-SUITE.md cross-references a now-deleted CORE-SUITE scenario: `tools/sandbox/SANDBOX-FABRIC-SUITE.md:204`
...
Write your full report to this file: /home/knatte/Code/loomyard/wts/fabric-cutover/_mill/briefs/review-code-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/loomyard/wts/fabric-cutover/_mill/briefs/review-code-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/loomyard/wts/fabric-cutover/_mill/briefs/review-code-holistic-r3.out.md`
