...
You are an independent discussion reviewer for **Diagnostic tracing (trace) on the logger module**. Round **3**. Reviewer model: **opushigh**.
...
Write your full report to this file: C:\Code\loomyard\wts\trace-logging\_mill\briefs\review-discussion-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\trace-logging\_mill\briefs\review-discussion-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\trace-logging\_mill\briefs\review-discussion-holistic-r3.out.md`
