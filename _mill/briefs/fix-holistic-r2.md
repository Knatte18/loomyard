...
- **Holistic review file:** `C:\Code\loomyard\wts\weft-engine\_mill\reviews\20260619-170803-code-review-r2.md`
...
Load the **mill-receiving-review** skill before reading any finding in `C:\Code\loomyard\wts\weft-engine\_mill\reviews\20260619-170803-code-review-r2.md`. This is non-negotiable.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"7e65cb32-c799-466b-80e3-b59bcd3a344d"}
```
...
**`session_id` MUST be exactly `7e65cb32-c799-466b-80e3-b59bcd3a344d` (the UUID shown in the example above — it was injected into this brief when it was rendered). Copy it verbatim.**

or, when stuck:

```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"7e65cb32-c799-466b-80e3-b59bcd3a344d"}
```
**Do not wrap the JSON in a code block. Output it as a bare line — no backticks, no fence. Anything other than a bare JSON line is treated as `stuck_type: logic`.**
