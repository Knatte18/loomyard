...
- **Holistic review file:** `/home/knatte/Code/loomyard/wts/fabric-weft-visibility-cleanup/_mill/reviews/20260807-192703-code-review-r2.md`
...
Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/loomyard/wts/fabric-weft-visibility-cleanup/_mill/reviews/20260807-192703-code-review-r2.md`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"d776a959-aa8b-42a4-9d67-53648b9c6e25"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `d776a959-aa8b-42a4-9d67-53648b9c6e25` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"d776a959-aa8b-42a4-9d67-53648b9c6e25"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
