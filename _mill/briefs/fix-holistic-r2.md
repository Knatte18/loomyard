...
- **Holistic review file:** `/home/knatte/Code/loomyard/wts/fabric-clone-subpath/_mill/reviews/20260801-105801-code-review-r2.md`
...
Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/loomyard/wts/fabric-clone-subpath/_mill/reviews/20260801-105801-code-review-r2.md`. This is non-negotiable.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"b1c729c2-584d-4793-813b-b637dcbf4d4c"}
```
...
**`session_id` MUST be exactly `b1c729c2-584d-4793-813b-b637dcbf4d4c` (the UUID shown in the example above — it was injected into this brief when it was rendered). Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"b1c729c2-584d-4793-813b-b637dcbf4d4c"}
```
**Do not wrap the JSON in a code block. Output it as a bare line — no backticks, no fence. Anything other than a bare JSON line is treated as `stuck_type: logic`.**
