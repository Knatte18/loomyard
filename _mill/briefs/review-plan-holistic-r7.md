...
Reviewer model: **sonnetxhigh**. Round **7**.
...
Write your full report to this file: C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\briefs\review-plan-holistic-r7.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\briefs\review-plan-holistic-r7.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE C:\Code\loomyard\wts\fabric-snapshot-trailer\_mill\briefs\review-plan-holistic-r7.out.md`
