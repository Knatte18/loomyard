...
- [stencil.md](stencil.md) — `internal/stencil`: fill marker fields in a markdown template → prompt (fails on an unfilled marker); 🚧 in progress — build started (independent leaf)
