...
Each condition was a fresh `general-purpose` subagent (Claude Sonnet 5) given only the task description and either a mandate or a prohibition on using `lyx scout`. Full agent prompts are reproduced in the "Task" sections below.
