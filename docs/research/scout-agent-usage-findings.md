...
**Date:** 2026-07-29.
Full raw data: [docs/benchmarks/scout-vs-grep.md](../benchmarks/scout-vs-grep.md).
Related design follow-up: [manifest/designs/scout-plan-symbol-fields.md](../../manifest/designs/scout-plan-symbol-fields.md).
...
This landed on exactly the tool this session built earlier the same day to remove human/agent judgment calls from a mill batch's `Deletes:`/`Moves:` safety check (see [manifest/designs/scout-plan-symbol-fields.md](../../manifest/designs/scout-plan-symbol-fields.md)).
