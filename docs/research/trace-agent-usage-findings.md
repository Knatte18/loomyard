...
**Context:** ad-hoc investigation on the `trace-v1` branch, after the module (and its `trace-daemon-persistence` follow-up) had already shipped. **Date:** 2026-07-29. Full raw data: [docs/benchmarks/trace-vs-grep.md](../benchmarks/trace-vs-grep.md). Related design follow-up: [manifest/designs/trace-plan-symbol-fields.md](../../manifest/designs/trace-plan-symbol-fields.md).
