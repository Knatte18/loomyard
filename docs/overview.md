...
- **Durable contract/reference docs** (`docs/reference/`) pin cross-module file contracts a real consumer honors — they are **kept**, not deleted on landing: `status-schema.md`, `discussion-format.md`, `plan-format-v3.md`, `webster-contract.md`, `model-spec.md`.
