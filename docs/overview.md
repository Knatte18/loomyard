...
- **Durable contract/reference docs** (`docs/reference/`) pin cross-module file contracts a real consumer honors — they are **kept**, not deleted on landing: `status-schema.md`, `discussion-format.md`, `plan-format.md`, `webster-contract.md`, `model-spec.md`.
...
- [webster-contract.md](reference/webster-contract.md) — webster's cross-module contract: the `_lyx/webster/` boundary, `outcome.yaml`, and the `summary.md` artifact Finalize consumes (as-built;
