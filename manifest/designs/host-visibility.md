...
Can use the same junction mechanism raddle already uses — junctions work for directories, and this is a directory of docs.
...
- [`internal/fabricengine`](../../internal/fabricengine/doc.go) — owns the junction re-pointing mechanism this could reuse for the `CONSTRAINTS.md`-equivalent directory.
