...
> **Status: designed, not implemented.** Supersedes `contracts/specs/loom-plan-spec.md`'s Card fields, `contracts/stencils/loom/loom-template-discussion.md`, and `contracts/stencils/loom/loom-template-plan.md` — none of these are rewritten yet. `manifest/designs/scout-plan-symbol-fields.md` and `manifest/designs/webster-parallel-execution.md` predate this doc and are stale; reconcile or delete them when this lands.
