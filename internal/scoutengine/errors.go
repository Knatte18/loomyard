// errors.go defines the typed error vocabulary the scoutengine package
// returns to its sole caller, internal/scoutcli. Each failure mode gets
...
// errors.Is(err, scoutengine.ErrServerNotFoundSentinel) without needing
