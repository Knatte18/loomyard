// definition_test.go is the untagged, spawn-free counterpart to any future definition_integration_test.go, mirroring refs_test.go's style exactly: it exercises Definition's error-mapping path that does not require a real language server.
