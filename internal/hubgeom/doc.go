...
//
// hubgeom's contract today is ReedGeometry, BurlerGeometry, PerchGeometry, and WebsterGeometry,
// converting a Location into a reedengine.Geometry, a burlerengine.Geometry, a perchengine.Geometry,
// and a websterengine.Geometry respectively.
