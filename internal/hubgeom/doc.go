...
//
// hubgeom's whole contract today is ReedGeometry, converting a Location into a reedengine.Geometry.
// Later waves add their own siblings here rather than spawning per-engine packages or re-deriving the
// construction inline at each call site: T6 adds BurlerGeometry and PerchGeometry, T7 adds
// WebsterGeometry.
//
