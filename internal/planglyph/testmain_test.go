...
// adds to this package that spawn git via the (*quarry.Repo) git-delta query, per the Hermetic Git
// Test Environment Invariant (CONSTRAINTS.md). This batch's own tests spawn no process — they
