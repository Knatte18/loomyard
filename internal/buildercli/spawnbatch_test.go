...
// newScratchRepo, mustGit, and commitFile live in gitfixture_test.go
// (tagged `integration || smoke`) so smoke_test.go compiles against the
// same scratch-git helpers this file uses.
