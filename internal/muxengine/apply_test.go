...
func TestPlanLayout_MatchesRenderRulesForCanonicalStrandTable(t *testing.T) {
	...
	}, render.Box{X: 0, Y: 0, W: 100, H: 21}, render.Params{TopBandRows: 3, CollapsedStripRows: 2, MinFullRows: 3})
	if err != nil {
...
func TestPlanLayout_HiddenStrandExcludedFromPlacement(t *testing.T) {
	...
	}, render.Box{X: 0, Y: 0, W: 80, H: 12}, render.Params{TopBandRows: 3, CollapsedStripRows: 2, MinFullRows: 3})
	if err != nil {
		t.Fatalf("render.Rules() unexpected error: %v", err)
	}
