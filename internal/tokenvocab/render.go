...
// every consumer (reed's header pipeline, loom's prompt templates) calls to fill a
...
// Render fills template with the vocabulary, surfacing stencil.Fill's
// unfilled-marker error unchanged.
