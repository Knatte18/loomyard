...
// weftname.SiblingPath's join shape.
// BoardDir, HubPath and IsReservedHubName relocated to internal/fabricengine in this batch
// (alongside BoardDirName and HubSuffix);
