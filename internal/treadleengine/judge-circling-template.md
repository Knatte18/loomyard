...
came back BLOCKING. Your only job is to read the previous handoff and the listed prior
review files, answer one question — **is this block going in circles?** — and maintain the
handoff for the next call.
...
file listed above, in order, alongside the previous handoff's ledger. Compare the NEWEST
round's findings against the earlier rounds' (via the handoff's ledger for anything older
than this list covers): is the same underlying issue recurring — reworded, relocated, or
