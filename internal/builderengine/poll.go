...
// PollUntilTerminal repeatedly calls gather on pollTick cadence until terminal or wait elapses.
// Terminal results return immediately.
// If wait elapses, returns the last running digest.
// gather errors propagate.
