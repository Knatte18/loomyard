...
Tests prove the --json path end-to-end;
help-tree pins reflect the new flag.
...
Run `git mv 03-refactor-a.md 03-refactor-a-renamed.md` first, before any other change to the moved file;
then make only the surgical edits Card 02.2's What: describes — never write the relocated file from scratch and delete the original.
