// fingerprint_test.go covers Fingerprint's identity properties: identical directories fingerprint identically,
// and a rename, a one-byte content edit, or an added batch file each change the result, while non-.md entries and subdirectories are ignored entirely.
