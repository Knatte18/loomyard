// pause.go implements the `pause` perch verb: it writes the pause flag file a running block's
// PauseRequested seam polls between rounds, requesting the block honor a pause at the next round
