...
// lyxtest.HermeticGitEnv() runs once before any test, so fabriccli's git-spawning fixtures never
...
// TestMain runs lyxtest.HermeticGitEnv() before any test spawns git.
