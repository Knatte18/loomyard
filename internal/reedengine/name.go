...
// the pure token substitution that turns reed.yaml's strand_name template
...
// FormatStrandName substitutes <WORKTREE>, <ROLE>, <ROUND>, <SHORT_GUID>
// tokens in template with values from parts. Pure; does no I/O.
