...
// TestMouseBootIntegration_PinsOptionAtBoot boots a fresh engine with Mouse set to "off" and then,
// on a separate fresh hub, "on", asserting the live server reports the matching value after Up() in
// both directions.
