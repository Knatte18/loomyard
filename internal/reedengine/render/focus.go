...
// and detects whether a strand has a descendant present in the ordered stack — the isAncestor test the height policy (height.go) uses to decide whether a shrink:true strand collapses to a compact strip.
