...
//
// Provides the default YAML template for reed configuration. The template
...
// (tmux/shell/claude) and debug_log, allowing environment-based overrides
...
// literals. On Windows the tmux/shell defaults are the machine's
