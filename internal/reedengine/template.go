...
// Exactly four keys use the ${env:VAR:-default} syntax, allowing environment-based overrides while
// preserving defaults when not set: the two machine tool paths (tmux, shell) plus debug_log and
// mouse.
