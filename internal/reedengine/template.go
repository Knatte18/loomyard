...
// The template uses ${env:VAR:-default} syntax for the machine tool paths (tmux/shell/claude) and
// debug_log, allowing environment-based overrides while preserving defaults when not set;
// the layout-tuning keys (width, height, collapsed_strip_rows, min_full_rows, strand_name) are
// plain literals.
