// name_test.go table-tests FormatStrandName's token substitution and verifies newGUID produces unique, well-formed hex identifiers.
...
func TestFormatStrandName(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			parts:    map[string]string{"<WORKTREE>": "internal-reed", "<ROLE>": "main"},
			want:     "internal-reed/main",
		},
		{
