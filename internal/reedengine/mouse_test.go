// mouse_test.go exercises mouseOption's validate/normalize contract: valid on/off inputs (in every
// case/whitespace variant) resolve to the canonical lowercase form,
