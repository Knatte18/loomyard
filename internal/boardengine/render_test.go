...
func TestRenderToDisk(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			out:          boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"},
			ghostFile:    "proposal-ghost.md",
			wantProposal: "proposal-a.md",
		},
		{
			name:         "TestRenderToDiskWithCustomProposalPrefix",
			out:          boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "prop-"},
...
func TestRenderToDiskManifestCleanup(t *testing.T) {
	t.Run("HomeRename", func(t *testing.T) {
		...
		out1 := boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"}
		...
		out2 := boardengine.Outputs{Home: "Index.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"}
	...
	t.Run("SidebarRename", func(t *testing.T) {
		...
		out2 := boardengine.Outputs{Home: "Home.md", Sidebar: "_Nav.md", ProposalPrefix: "proposal-"}
		if err := boardengine.RenderToDisk(dir, tasks, out2); err != nil {
			t.Fatalf("second RenderToDisk: %v", err)
		}
	...
	t.Run("ProposalPrefixChange", func(t *testing.T) {
		...
		out2 := boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "task-"}
		if err := boardengine.RenderToDisk(dir, tasks, out2); err != nil {
			t.Fatalf("second RenderToDisk: %v", err)
		}
...
func TestRenderEmptyTaskList(t *testing.T) {
	...
	result, err := boardengine.Render([]boardengine.Task{}, boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"})
	if err != nil {
...
func TestRenderProposalAndShapesHomepage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := boardengine.Render(tt.tasks, boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"})
			if err != nil {
				t.Fatalf("Render failed: %v", err)
			}
...
func TestRenderStatusVariants(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := boardengine.Render([]boardengine.Task{task}, boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"})
			if err != nil {
				t.Fatalf("Render failed: %v", err)
			}
...
func TestRenderSingleTask(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := boardengine.Render([]boardengine.Task{tt.task}, boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"})
			if err != nil {
				t.Fatalf("Render failed: %v", err)
			}
...
func TestRenderSidebarExtendedTitle(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			task: boardengine.Task{ID: 1, Slug: "task-a", Title: "Task A"},
	...
	t.Run(tests[0].name, func(t *testing.T) {
		result, err := boardengine.Render([]boardengine.Task{tests[0].task}, boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"})
		if err != nil {
			t.Fatalf("Render failed: %v", err)
		}
	...
	t.Run("TestRenderSidebarBlanks", func(t *testing.T) {
		taskA := boardengine.Task{ID: 1, Slug: "task-a", Title: "Task A"}
		doneStatus := "done"
		taskDone := boardengine.Task{ID: 2, Slug: "task-done", Title: "Done Task", Status: &doneStatus}

		result, err := boardengine.Render([]boardengine.Task{taskA, taskDone}, boardengine.Outputs{Home: "Home.md", Sidebar: "_Sidebar.md", ProposalPrefix: "proposal-"})
		if err != nil {
			t.Fatalf("Render failed: %v", err)
		}
