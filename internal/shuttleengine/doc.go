...
// and what "done" means. It does not own panes, layout, or psmux mechanics —
// it asks mux for a strand and drives the LLM in it.
//
// Every agent runs as an interactive psmux session, never headless
...
// how to launch and drive its provider as a psmux session — construct the
...
// Nothing here calls psmux or claude, or knows about either.
