// strand_test.go covers StrandLive against a fake shuttleengine.ReedOps double (present/live,
// present/not-live, absent), TurnEnded against a fake shuttleengine.Engine double (stop event, no
