...
// overrides round-trip, and a malformed role model-spec fails loud naming the offending key — the
// builderengine config_test.go pattern, but seeded via plain os.MkdirAll/os.WriteFile against a
