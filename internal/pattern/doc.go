// doc.go carries the package godoc for pattern: the active check, why it is pure existence, why the three roles are what they are, and why the injected pointer stays a relative path.
