...
// making re-installation idempotent. It is deliberately distinct from warp's
// hookSentinel so the two modules' hooks never collide, whether standalone or
// chained together on the same repo.
