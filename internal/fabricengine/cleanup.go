...
type CleanupBranchEntry struct {
	...
	// Protected reports whether the branch was skipped rather than deleted — either
	// because raddleFoldedBack returned false and force was not set, or because the
