...
// TestAdd_ExistingBranchErrorNamesRemedy creates the host branch a slug would claim, calls Add with that slug, and asserts the rejection names both remedies (checkout onto it, or delete the leftover).
