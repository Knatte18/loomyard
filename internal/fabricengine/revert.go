// revert.go resolves a warp SHA to its corresponding weft SHA via the correspondence index:
// classifyCorrespondence is the pure gap-classification core, extracted so it is testable without
// spawning git;
