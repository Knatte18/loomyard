...
var excludedModules = map[string]string{
	...
	"scout":      "requires an external language-server binary (gopls/pyright/csharp-ls) on $PATH; exercised by //go:build integration tests, not the black-box sandbox suite",
}
