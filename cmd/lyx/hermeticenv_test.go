...
var allowedNonHermetic = map[string]string{
	...
	"internal/codeintelengine":                "spawns gopls and go install for EnsureServer/toolchain-manager integration coverage, plus short-lived test-only subprocesses for PID-liveness fixtures (batches 4, 6); never git",
