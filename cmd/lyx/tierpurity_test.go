...
var allowedSpawners = map[string]string{
	...
	"internal/traceengine/daemonstate_test.go": "spawns a short-lived child process to obtain a confirmed-dead PID for the daemon-staleness fixture, mirroring internal/proc's own liveness-test technique",
	"internal/traceengine/supervised_test.go":  "spawns short-lived test subprocesses for the retry-exhaustion PID-liveness fixture and the stale-socket-cleanup bind proof",
