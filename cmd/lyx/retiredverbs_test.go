...
// decision). This is a pure command-tree walk: no external process spawn, no real git repository,
// and no real hub fixture build, per the Test Tier Purity Invariant.
